...
export async function generateStaticParams() {
  return [{ number: "029", slug: "al-ankabut" }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Surah Al-Ankabut (العنكبوت) — The Spider | TajweedTranslit",
    description: "Read Surah Al-Ankabut (The Spider) — 69 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.",
    keywords: [
      "Surah Al-Ankabut transliteration",
      "Surah 29 tajweed",
      "Al-Ankabut meaning",
      "Quran al-ankabut transliteration",
      "learn quran al-ankabut",
      "quran recitation al-ankabut",
      "tajweed al-ankabut",
    ],
    alternates: { canonical: `/surah/29/al-ankabut` },
    openGraph: {
      title: "Surah Al-Ankabut (العنكبوت) — The Spider",
      description: "Read Surah Al-Ankabut in English transliteration with Tajweed colour coding. 69 verses, Meccan.",
      url: `/surah/29/al-ankabut`,
      type: "article",
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Al-Ankabut</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">العنكبوت</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Al-Ankabut</h2>
        <p className="text-lg text-secondary italic mb-4">The Spider</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Al-Ankabut with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 795
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah Al-Ankabut</h3>
          <p className="text-secondary leading-relaxed">Contains the parable of the spider's house — the weakest of homes.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Al-Ankabut is Special</h3>
          <p className="text-secondary leading-relaxed">The surah in which Allah declares He will help His servants.</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">69</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Spider</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/795" className="text-accent hover:underline">
                  Page 795 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Al-Ankabut at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
