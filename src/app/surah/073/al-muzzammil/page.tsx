...
export async function generateStaticParams() {
  return [{ number: '073', slug: 'al-muzzammil' }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah Al-Muzzammil (المزمل) — The Enshrouded One | TajweedTranslit',
    description: 'Read Surah Al-Muzzammil (The Enshrouded One) — 20 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah Al-Muzzammil transliteration',
      'Surah 73 tajweed',
      'Al-Muzzammil meaning',
      'Quran al-muzzammil transliteration',
      'learn quran al-muzzammil',
      'quran recitation al-muzzammil',
      'tajweed al-muzzammil',
    ],
    alternates: { canonical: '/surah/73/al-muzzammil' },
    openGraph: {
      title: 'Surah Al-Muzzammil (المزمل) — The Enshrouded One',
      description: 'Read Surah Al-Muzzammil in English transliteration with Tajweed colour coding. 20 verses, Meccan.',
      url: '/surah/73/al-muzzammil',
      type: 'article',
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Al-Muzzammil</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">المزمل</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Al-Muzzammil</h2>
        <p className="text-lg text-secondary italic mb-4">The Enshrouded One</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Al-Muzzammil with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 1151
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah Al-Muzzammil</h3>
          <p className="text-secondary leading-relaxed">Commands the Prophet to rise in the night for prayer (Tahajjud).</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Al-Muzzammil is Special</h3>
          <p className="text-secondary leading-relaxed">Contains the famous verse: "From the night, pray an extra portion — perhaps your Lord will raise you to a praised position."</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">20</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Enshrouded One</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/1151" className="text-accent hover:underline">
                  Page 1151 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Al-Muzzammil at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
