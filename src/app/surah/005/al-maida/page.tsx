...
export async function generateStaticParams() {
  return [{ number: '005', slug: 'al-maida' }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah Al-Ma'ida (المائدة) — The Table Spread | TajweedTranslit',
    description: 'Read Surah Al-Ma'ida (The Table Spread) — 120 verses, Medinan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah Al-Ma'ida transliteration',
      'Surah 5 tajweed',
      'Al-Ma'ida meaning',
      'Quran al-ma'ida transliteration',
      'learn quran al-ma'ida',
      'quran recitation al-ma'ida',
      'tajweed al-ma'ida',
    ],
    alternates: { canonical: '/surah/5/al-maida' },
    openGraph: {
      title: 'Surah Al-Ma'ida (المائدة) — The Table Spread',
      description: 'Read Surah Al-Ma'ida in English transliteration with Tajweed colour coding. 120 verses, Medinan.',
      url: '/surah/5/al-maida',
      type: 'article',
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Al-Ma'ida</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">المائدة</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Al-Ma'ida</h2>
        <p className="text-lg text-secondary italic mb-4">The Table Spread</p>
        <div className="flex flex-wrap justify-center items-center gap-4 text-sm text-muted">
          <span>🏙️ Medinan Revelation</span>
          <span>•</span>
          <span>120 verses</span>
          <span>•</span>
          <span>Page 215</span>
        </div>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Al-Ma'ida with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 215
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah Al-Ma'ida</h3>
          <p className="text-secondary leading-relaxed">Al-Ma'ida addresses lawful and unlawful food, the story of the table spread from heaven, and the covenant with the People of the Book.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Al-Ma'ida is Special</h3>
          <p className="text-secondary leading-relaxed">Establishes the rules of halal food and the obligation to uphold previous scriptures.</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">120</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Table Spread</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/215" className="text-accent hover:underline">
                  Page 215 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Al-Ma'ida at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
