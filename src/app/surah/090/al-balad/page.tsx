...
export async function generateStaticParams() {
  return [{ number: '090', slug: 'al-balad' }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah Al-Balad (البلد) — The City | TajweedTranslit',
    description: 'Read Surah Al-Balad (The City) — 20 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah Al-Balad transliteration',
      'Surah 90 tajweed',
      'Al-Balad meaning',
      'Quran al-balad transliteration',
      'learn quran al-balad',
      'quran recitation al-balad',
      'tajweed al-balad',
    ],
    alternates: { canonical: '/surah/90/al-balad' },
    openGraph: {
      title: 'Surah Al-Balad (البلد) — The City',
      description: 'Read Surah Al-Balad in English transliteration with Tajweed colour coding. 20 verses, Meccan.',
      url: '/surah/90/al-balad',
      type: 'article',
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Al-Balad</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">البلد</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Al-Balad</h2>
        <p className="text-lg text-secondary italic mb-4">The City</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Al-Balad with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 1191
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah Al-Balad</h3>
          <p className="text-secondary leading-relaxed">Addresses the difficulty of the path and emphasizes that guiding to the right path is also difficult.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Al-Balad is Special</h3>
          <p className="text-secondary leading-relaxed">Contains the verse: "Indeed, We have shown him the way, whether he be grateful or ungrateful."</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">90</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The City</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/1191" className="text-accent hover:underline">
                  Page 1191 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Al-Balad at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
