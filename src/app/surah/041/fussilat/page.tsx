...
export async function generateStaticParams() {
  return [{ number: '041', slug: 'fussilat' }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah Fussilat (فصلت) — Explained in Detail | TajweedTranslit',
    description: 'Read Surah Fussilat (Explained in Detail) — 54 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah Fussilat transliteration',
      'Surah 41 tajweed',
      'Fussilat meaning',
      'Quran fussilat transliteration',
      'learn quran fussilat',
      'quran recitation fussilat',
      'tajweed fussilat',
    ],
    alternates: { canonical: '/surah/41/fussilat' },
    openGraph: {
      title: 'Surah Fussilat (فصلت) — Explained in Detail',
      description: 'Read Surah Fussilat in English transliteration with Tajweed colour coding. 54 verses, Meccan.',
      url: '/surah/41/fussilat',
      type: 'article',
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Fussilat</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">فصلت</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Fussilat</h2>
        <p className="text-lg text-secondary italic mb-4">Explained in Detail</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Fussilat with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 957
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        <section className="rounded-xl border border-border bg-surface p-6">
          ...
          <p className="text-secondary leading-relaxed">Contains the verse: "This is a mercy from your Lord."</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">41</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">Explained in Detail</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/957" className="text-accent hover:underline">
                  Page 957 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Fussilat at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
      ...
      <li class="flex items-center gap-2">
        ...
        <section className="grid grid-cols-2 gap-4">
          ...
          <Link href={"/surah/42/" + "ash-shura"} className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">Next →</span>
            <p className="mt-1 font-semibold text-foreground">Surah Ash-Shura</p>
          </Link>
        </section>
