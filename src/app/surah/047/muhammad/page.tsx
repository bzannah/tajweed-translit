...
export async function generateStaticParams() {
  return [{ number: '047', slug: 'muhammad' }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah Muhammad (محمد) — Muhammad | TajweedTranslit',
    description: 'Read Surah Muhammad (Muhammad) — 38 verses, Medinan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah Muhammad transliteration',
      'Surah 47 tajweed',
      'Muhammad meaning',
      'Quran muhammad transliteration',
      'learn quran muhammad',
      'quran recitation muhammad',
      'tajweed muhammad',
    ],
    alternates: { canonical: '/surah/47/muhammad' },
    openGraph: {
      title: 'Surah Muhammad (محمد) — Muhammad',
      description: 'Read Surah Muhammad in English transliteration with Tajweed colour coding. 38 verses, Medinan.',
      url: '/surah/47/muhammad',
      type: 'article',
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Muhammad</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">محمد</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Muhammad</h2>
        <p className="text-lg text-secondary italic mb-4">Muhammad</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Muhammad with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 1017
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah Muhammad</h3>
          <p className="text-secondary leading-relaxed">Addresses the believers about fighting the disbelievers and the consequences of hypocrisy.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Muhammad is Special</h3>
          <p className="text-secondary leading-relaxed">Contains the verse: "Allah has promised those who believe and do righteous deeds."</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">47</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">Muhammad</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/1017" className="text-accent hover:underline">
                  Page 1017 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Muhammad at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
