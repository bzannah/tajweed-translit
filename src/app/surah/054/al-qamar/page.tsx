...
export async function generateStaticParams() {
  return [{ number: '054', slug: 'al-qamar' }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah Al-Qamar (القمر) — The Moon | TajweedTranslit',
    description: 'Read Surah Al-Qamar (The Moon) — 55 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah Al-Qamar transliteration',
      'Surah 54 tajweed',
      'Al-Qamar meaning',
      'Quran al-qamar transliteration',
      'learn quran al-qamar',
      'quran recitation al-qamar',
      'tajweed al-qamar',
    ],
    alternates: { canonical: '/surah/54/al-qamar' },
    openGraph: {
      title: 'Surah Al-Qamar (القمر) — The Moon',
      description: 'Read Surah Al-Qamar in English transliteration with Tajweed colour coding. 55 verses, Meccan.',
      url: '/surah/54/al-qamar',
      type: 'article',
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Al-Qamar</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">القمر</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Al-Qamar</h2>
        <p className="text-lg text-secondary italic mb-4">The Moon</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Al-Qamar with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 1059
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah Al-Qamar</h3>
          <p className="text-secondary leading-relaxed">Addresses the splitting of the moon — a miracle of Prophet Muhammad.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Al-Qamar is Special</h3>
          <p className="text-secondary leading-relaxed">Contains the famous verse: "The Hour has come closer, and the moon has been split."</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">54</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
              <dt className="text-muted text-xs uppercase tracking-wide">Verses</dt>
              <dd className="mt-1 text-lg font-semibold text-foreground">55</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Moon</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/1059" className="text-accent hover:underline">
                  Page 1059 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Al-Qamar at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
      ...
      <li class="flex items-center gap-2">
        ...
        <section className="grid grid-cols-2 gap-4">
          <Link href={"/surah/53/" + "an-najm"} className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">← Previous</span>
            <p className="mt-1 font-semibold text-foreground">Surah An-Najm</p>
          </Link>
