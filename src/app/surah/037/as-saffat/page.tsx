...
export async function generateStaticParams() {
  return [{ number: "037", slug: "as-saffat" }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Surah As-Saffat (الصافات) — Those Ranged in Ranks | TajweedTranslit",
    description: "Read Surah As-Saffat (Those Ranged in Ranks) — 182 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.",
    keywords: [
      "Surah As-Saffat transliteration",
      "Surah 37 tajweed",
      "As-Saffat meaning",
      "Quran as-saffat transliteration",
      "learn quran as-saffat",
      "quran recitation as-saffat",
      "tajweed as-saffat",
    ],
    alternates: { canonical: `/surah/37/as-saffat` },
    openGraph: {
      title: "Surah As-Saffat (الصافات) — Those Ranged in Ranks",
      description: "Read Surah As-Saffat in English transliteration with Tajweed colour coding. 182 verses, Meccan.",
      url: `/surah/37/as-saffat`,
      type: "article",
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah As-Saffat</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">الصافات</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah As-Saffat</h2>
        <p className="text-lg text-secondary italic mb-4">Those Ranged in Ranks</p>
        <div className="flex flex-wrap justify-center items-center gap-4 text-sm text-muted">
          <span>🏔️ Meccan Revelation</span>
          <span>•</span>
          <span>182 verses</span>
          <span>•</span>
          <span>Page 895</span>
        </div>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah As-Saffat with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 895
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah As-Saffat</h3>
          <p className="text-secondary leading-relaxed">Depicts the angels ranged in rows and the stories of Ibrahim and his son Ismail.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah As-Saffat is Special</h3>
          <p className="text-secondary leading-relaxed">Contains the story of Ibrahim's sacrifice — one of the most important narratives.</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">182</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">Those Ranged in Ranks</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/895" className="text-accent hover:underline">
                  Page 895 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah As-Saffat at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
        ...
        <section className="grid grid-cols-2 gap-4">
          <Link href="/surah/36/ya-sin" className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">← Previous</span>
            <p className="mt-1 font-semibold text-foreground">Surah Ya-Sin</p>
          </Link>
          <Link href="/surah/38/sad" className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">Next →</span>
            <p className="mt-1 font-semibold text-foreground">Surah Sad</p>
          </Link>
        </section>
