...
export async function generateStaticParams() {
  return [{ number: '006', slug: 'al-anam' }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah Al-An'am (الأنعام) — The Cattle | TajweedTranslit',
    description: 'Read Surah Al-An'am (The Cattle) — 165 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah Al-An'am transliteration',
      'Surah 6 tajweed',
      'Al-An'am meaning',
      'Quran al-an'am transliteration',
      'learn quran al-an'am',
      'quran recitation al-an'am',
      'tajweed al-an'am',
    ],
    alternates: { canonical: '/surah/6/al-anam' },
    openGraph: {
      title: 'Surah Al-An'am (الأنعام) — The Cattle',
      description: 'Read Surah Al-An'am in English transliteration with Tajweed colour coding. 165 verses, Meccan.',
      url: '/surah/6/al-anam',
      type: 'article',
    },
  };
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <header className="px-4 py-12 text-center">
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Al-An'am with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 259
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">165</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Cattle</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/259" className="text-accent hover:underline">
                  Page 259 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Al-An'am at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
