...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah Ar-Rum (الروم) — The Romans | TajweedTranslit',
    description: 'Read Surah Ar-Rum (The Romans) — 60 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah Ar-Rum transliteration',
      'Surah 30 tajweed',
      'Ar-Rum meaning',
      'Quran ar-rum transliteration',
      'learn quran ar-rum',
      'quran recitation ar-rum',
      'tajweed ar-rum',
    ],
    alternates: { canonical: '/surah/30/ar-rum' },
    openGraph: {
      title: 'Surah Ar-Rum (الروم) — The Romans',
      description: 'Read Surah Ar-Rum in English transliteration with Tajweed colour coding. 60 verses, Meccan.',
      url: '/surah/30/ar-rum',
      type: 'article',
    },
  };
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Ar-Rum</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">الروم</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Ar-Rum</h2>
        <p className="text-lg text-secondary italic mb-4">The Romans</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Ar-Rum with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 811
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah Ar-Rum</h3>
          <p className="text-secondary leading-relaxed">Predicted the Roman victory over Persia within 3–9 years — a prophecy fulfilled exactly.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Ar-Rum is Special</h3>
          <p className="text-secondary leading-relaxed">Contains the famous verse: "Do they not see how Allah brings the dead to life?"</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Romans</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/811" className="text-accent hover:underline">
                  Page 811 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Ar-Rum at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
