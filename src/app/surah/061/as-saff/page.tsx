...
export async function generateStaticParams() {
  return [{ number: '061', slug: 'as-saff' }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah As-Saff (الصف) — The Ranks | TajweedTranslit',
    description: 'Read Surah As-Saff (The Ranks) — 14 verses, Medinan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah As-Saff transliteration',
      'Surah 61 tajweed',
      'As-Saff meaning',
      'Quran as-saff transliteration',
      'learn quran as-saff',
      'quran recitation as-saff',
      'tajweed as-saff',
    ],
    alternates: { canonical: '/surah/61/as-saff' },
    openGraph: {
      title: 'Surah As-Saff (الصف) — The Ranks',
      description: 'Read Surah As-Saff in English transliteration with Tajweed colour coding. 14 verses, Medinan.',
      url: '/surah/61/as-saff',
      type: 'article',
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah As-Saff</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">الصف</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah As-Saff</h2>
        <p className="text-lg text-secondary italic mb-4">The Ranks</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah As-Saff with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 1105
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah As-Saff</h3>
          <p className="text-secondary leading-relaxed">Calls believers to be like a built structure — firm and united.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah As-Saff is Special</h3>
          <p className="text-secondary leading-relaxed">Contains the verse: "Indeed, Allah has purchased from the believers their lives and their properties."</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">61</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
              <dt className="text-muted text-xs uppercase tracking-wide">Verses</dt>
              <dd className="mt-1 text-lg font-semibold text-foreground">14</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Ranks</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/1105" className="text-accent hover:underline">
                  Page 1105 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah As-Saff at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
      ...
      <li class="flex items-center gap-2">
        ...
        <section className="grid grid-cols-2 gap-4">
          <Link href={"/surah/60/" + "al-mumtahina"} className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">← Previous</span>
            <p className="mt-1 font-semibold text-foreground">Surah Al-Mumtahina</p>
          </Link>
