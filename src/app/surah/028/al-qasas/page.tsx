...
export async function generateStaticParams() {
  return [{ number: '028', slug: 'al-qasas' }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah Al-Qasas (القصص) — The Stories | TajweedTranslit',
    description: 'Read Surah Al-Qasas (The Stories) — 88 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah Al-Qasas transliteration',
      'Surah 28 tajweed',
      'Al-Qasas meaning',
      'Quran al-qasas transliteration',
      'learn quran al-qasas',
      'quran recitation al-qasas',
      'tajweed al-qasas',
    ],
    alternates: { canonical: '/surah/28/al-qasas' },
    openGraph: {
      title: 'Surah Al-Qasas (القصص) — The Stories',
      description: 'Read Surah Al-Qasas in English transliteration with Tajweed colour coding. 88 verses, Meccan.',
      url: '/surah/28/al-qasas',
      type: 'article',
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Al-Qasas</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">القصص</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Al-Qasas</h2>
        <p className="text-lg text-secondary italic mb-4">The Stories</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Al-Qasas with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 773
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah Al-Qasas</h3>
          <p className="text-secondary leading-relaxed">Contains the detailed story of Musa (Moses) from birth to his mission.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Al-Qasas is Special</h3>
          <p className="text-secondary leading-relaxed">Contains the verse: "Indeed, he who comes to Allah with a sound heart comes with a good deed."</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">28</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Stories</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/773" className="text-accent hover:underline">
                  Page 773 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Al-Qasas at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
      ...
      <li class="flex items-center gap-2">
        ...
        <section className="grid grid-cols-2 gap-4">
          <Link href={"/surah/27/" + "an-naml"} className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">← Previous</span>
            <p className="mt-1 font-semibold text-foreground">Surah An-Naml</p>
          </Link>
          <Link href={"/surah/29/" + "al-ankabut"} className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">Next →</span>
            <p className="mt-1 font-semibold text-foreground">Surah Al-Ankabut</p>
          </Link>
        </section>
