...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah Saba (سبأ) — Sheba | TajweedTranslit',
    description: 'Read Surah Saba (Sheba) — 54 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah Saba transliteration',
      'Surah 34 tajweed',
      'Saba meaning',
      'Quran saba transliteration',
      'learn quran saba',
      'quran recitation saba',
      'tajweed saba',
    ],
    alternates: { canonical: '/surah/34/saba' },
    openGraph: {
      title: 'Surah Saba (سبأ) — Sheba',
      description: 'Read Surah Saba in English transliteration with Tajweed colour coding. 54 verses, Meccan.',
      url: '/surah/34/saba',
      type: 'article',
    },
  };
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Saba</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">سبأ</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Saba</h2>
        <p className="text-lg text-secondary italic mb-4">Sheba</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Saba with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 859
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah Saba</h3>
          <p className="text-secondary leading-relaxed">Named after the people of Sheba, recounting the story of Bilqis and Sulayman.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Saba is Special</h3>
          <p className="text-secondary leading-relaxed">Contains the verse: "This is indeed a noble Quran in a preserved Register."</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">Sheba</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/859" className="text-accent hover:underline">
                  Page 859 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Saba at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
