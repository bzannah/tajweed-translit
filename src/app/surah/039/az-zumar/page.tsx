...
export async function generateStaticParams() {
  return [{ number: '039', slug: 'az-zumar' }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah Az-Zumar (الزمر) — The Groups | TajweedTranslit',
    description: 'Read Surah Az-Zumar (The Groups) — 75 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah Az-Zumar transliteration',
      'Surah 39 tajweed',
      'Az-Zumar meaning',
      'Quran az-zumar transliteration',
      'learn quran az-zumar',
      'quran recitation az-zumar',
      'tajweed az-zumar',
    ],
    alternates: { canonical: '/surah/39/az-zumar' },
    openGraph: {
      title: 'Surah Az-Zumar (الزمر) — The Groups',
      description: 'Read Surah Az-Zumar in English transliteration with Tajweed colour coding. 75 verses, Meccan.',
      url: '/surah/39/az-zumar',
      type: 'article',
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Az-Zumar</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">الزمر</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Az-Zumar</h2>
        <p className="text-lg text-secondary italic mb-4">The Groups</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Az-Zumar with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 919
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah Az-Zumar</h3>
          <p className="text-secondary leading-relaxed">Addresses resurrection, accountability, and the parable of those who take guardians besides Allah.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Az-Zumar is Special</h3>
          <p className="text-secondary leading-relaxed">Contains the verse: "Is not the time come for those who have believed?"</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">39</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Groups</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/919" className="text-accent hover:underline">
                  Page 919 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Az-Zumar at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
      ...
      <li class="flex items-center gap-2">
        ...
        <section className="grid grid-cols-2 gap-4">
          ...
          <Link href={"/surah/40/" + "ghafir"} className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">Next →</span>
            <p className="mt-1 font-semibold text-foreground">Surah Ghafir</p>
          </Link>
        </section>
