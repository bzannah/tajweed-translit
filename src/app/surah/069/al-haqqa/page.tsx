...
export async function generateStaticParams() {
  return [{ number: '069', slug: 'al-haqqa' }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah Al-Haqqa (الحاقة) — The Reality | TajweedTranslit',
    description: 'Read Surah Al-Haqqa (The Reality) — 52 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah Al-Haqqa transliteration',
      'Surah 69 tajweed',
      'Al-Haqqa meaning',
      'Quran al-haqqa transliteration',
      'learn quran al-haqqa',
      'quran recitation al-haqqa',
      'tajweed al-haqqa',
    ],
    alternates: { canonical: '/surah/69/al-haqqa' },
    openGraph: {
      title: 'Surah Al-Haqqa (الحاقة) — The Reality',
      description: 'Read Surah Al-Haqqa in English transliteration with Tajweed colour coding. 52 verses, Meccan.',
      url: '/surah/69/al-haqqa',
      type: 'article',
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Al-Haqqa</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">الحاقة</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Al-Haqqa</h2>
        <p className="text-lg text-secondary italic mb-4">The Reality</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Al-Haqqa with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 1135
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah Al-Haqqa</h3>
          <p className="text-secondary leading-relaxed">Describes the Day of Judgment in vivid detail.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Al-Haqqa is Special</h3>
          <p className="text-secondary leading-relaxed">Contains the famous verse: "Indeed, this is the truth from your Lord."</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Reality</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/1135" className="text-accent hover:underline">
                  Page 1135 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Al-Haqqa at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
