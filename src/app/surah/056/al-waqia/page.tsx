...
export async function generateStaticParams() {
  return [{ number: '056', slug: 'al-waqia' }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah Al-Waqi'a (الواقعة) — The Inevitable | TajweedTranslit',
    description: 'Read Surah Al-Waqi'a (The Inevitable) — 96 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah Al-Waqi'a transliteration',
      'Surah 56 tajweed',
      'Al-Waqi'a meaning',
      'Quran al-waqi'a transliteration',
      'learn quran al-waqi'a',
      'quran recitation al-waqi'a',
      'tajweed al-waqi'a',
    ],
    alternates: { canonical: '/surah/56/al-waqia' },
    openGraph: {
      title: 'Surah Al-Waqi'a (الواقعة) — The Inevitable',
      description: 'Read Surah Al-Waqi'a in English transliteration with Tajweed colour coding. 96 verses, Meccan.',
      url: '/surah/56/al-waqia',
      type: 'article',
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Al-Waqi'a</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">الواقعة</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Al-Waqi'a</h2>
        <p className="text-lg text-secondary italic mb-4">The Inevitable</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Al-Waqi'a with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 1071
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah Al-Waqi'a</h3>
          <p className="text-secondary leading-relaxed">Describes the Day of Resurrection, dividing humanity into three groups.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Al-Waqi'a is Special</h3>
          <p className="text-secondary leading-relaxed">Reciting this Surah regularly protects from poverty.</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">96</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Inevitable</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/1071" className="text-accent hover:underline">
                  Page 1071 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Al-Waqi'a at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
      ...
      <li class="flex items-center gap-2">
        ...
        <section className="grid grid-cols-2 gap-4">
          <Link href={"/surah/55/" + "ar-rahman"} className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">← Previous</span>
            <p className="mt-1 font-semibold text-foreground">Surah Ar-Rahman</p>
          </Link>
