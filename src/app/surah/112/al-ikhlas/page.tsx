...
export async function generateStaticParams() {
  return [{ number: "112", slug: "al-ikhlas" }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Surah Al-Ikhlas (الإخلاص) — The Sincerity | TajweedTranslit",
    description: "Read Surah Al-Ikhlas (The Sincerity) — 4 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.",
    keywords: [
      "Surah Al-Ikhlas transliteration",
      "Surah 112 tajweed",
      "Al-Ikhlas meaning",
      "Quran al-ikhlas transliteration",
      "learn quran al-ikhlas",
      "quran recitation al-ikhlas",
      "tajweed al-ikhlas",
    ],
    alternates: { canonical: `/surah/112/al-ikhlas` },
    openGraph: {
      title: "Surah Al-Ikhlas (الإخلاص) — The Sincerity",
      description: "Read Surah Al-Ikhlas in English transliteration with Tajweed colour coding. 4 verses, Meccan.",
      url: `/surah/112/al-ikhlas`,
      type: "article",
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Al-Ikhlas</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">الإخلاص</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Al-Ikhlas</h2>
        <p className="text-lg text-secondary italic mb-4">The Sincerity</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Al-Ikhlas with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 1227
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah Al-Ikhlas</h3>
          <p className="text-secondary leading-relaxed">Declares the absolute oneness of Allah in its purest form. Reciting it equals one-third of the Quran.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Al-Ikhlas is Special</h3>
          <p className="text-secondary leading-relaxed">Reciting Al-Ikhlas in Salah equals reciting one-third of the Quran.</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">4</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Sincerity</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/1227" className="text-accent hover:underline">
                  Page 1227 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Al-Ikhlas at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
        ...
        <section className="grid grid-cols-2 gap-4">
          <Link href="/surah/111/al-masad" className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">← Previous</span>
            <p className="mt-1 font-semibold text-foreground">Surah Al-Masad</p>
          </Link>
