...
export async function generateStaticParams() {
  return [{ number: '016', slug: 'an-nahl' }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah An-Nahl (النحل) — The Bee | TajweedTranslit',
    description: 'Read Surah An-Nahl (The Bee) — 128 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah An-Nahl transliteration',
      'Surah 16 tajweed',
      'An-Nahl meaning',
      'Quran an-nahl transliteration',
      'learn quran an-nahl',
      'quran recitation an-nahl',
      'tajweed an-nahl',
    ],
    alternates: { canonical: '/surah/16/an-nahl' },
    openGraph: {
      title: 'Surah An-Nahl (النحل) — The Bee',
      description: 'Read Surah An-Nahl in English transliteration with Tajweed colour coding. 128 verses, Meccan.',
      url: '/surah/16/an-nahl',
      type: 'article',
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah An-Nahl</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">النحل</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah An-Nahl</h2>
        <p className="text-lg text-secondary italic mb-4">The Bee</p>
        <div className="flex flex-wrap justify-center items-center gap-4 text-sm text-muted">
          <span>🏔️ Meccan Revelation</span>
          <span>•</span>
          <span>128 verses</span>
          <span>•</span>
          <span>Page 537</span>
        </div>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah An-Nahl with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 537
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        <section>
          ...
          <p className="text-secondary leading-relaxed">Contains the evidences of Allah's creation including the bee, the seasons, the water cycle, and human civilization.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah An-Nahl is Special</h3>
          <p className="text-secondary leading-relaxed">Contains the verse: "Allah does not forbid you from being good to those who have not fought you."</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">16</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
              <dt className="text-muted text-xs uppercase tracking-wide">Verses</dt>
              <dd className="mt-1 text-lg font-semibold text-foreground">128</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Bee</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/537" className="text-accent hover:underline">
                  Page 537 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah An-Nahl at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
      ...
      <li class="flex items-center gap-2">
        ...
        <section className="grid grid-cols-2 gap-4">
          <Link href={"/surah/15/" + "al-hijr"} className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            ...
            <p className="mt-1 font-semibold text-foreground">Surah Al-Hijr</p>
          </Link>
