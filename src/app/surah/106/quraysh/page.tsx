...
export async function generateStaticParams() {
  return [{ number: "106", slug: "quraysh" }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Surah Quraysh (قريش) — Quraysh | TajweedTranslit",
    description: "Read Surah Quraysh (Quraysh) — 4 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.",
    keywords: [
      "Surah Quraysh transliteration",
      "Surah 106 tajweed",
      "Quraysh meaning",
      "Quran quraysh transliteration",
      "learn quran quraysh",
      "quran recitation quraysh",
      "tajweed quraysh",
    ],
    alternates: { canonical: `/surah/106/quraysh` },
    openGraph: {
      title: "Surah Quraysh (قريش) — Quraysh",
      description: "Read Surah Quraysh in English transliteration with Tajweed colour coding. 4 verses, Meccan.",
      url: `/surah/106/quraysh`,
      type: "article",
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Quraysh</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">قريش</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Quraysh</h2>
        <p className="text-lg text-secondary italic mb-4">Quraysh</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Quraysh with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 1215
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">106</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">Quraysh</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/1215" className="text-accent hover:underline">
                  Page 1215 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Quraysh at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
