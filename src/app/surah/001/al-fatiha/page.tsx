...
export async function generateStaticParams() {
  return [{ number: "001", slug: "al-fatiha" }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Surah Al-Fatiha (الفاتحة) — The Opening | TajweedTranslit",
    description: "Read Surah Al-Fatiha (The Opening) — 7 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.",
    keywords: [
      "Surah Al-Fatiha transliteration",
      "Surah 1 tajweed",
      "Al-Fatiha meaning",
      "Quran al-fatiha transliteration",
      "learn quran al-fatiha",
      "quran recitation al-fatiha",
      "tajweed al-fatiha",
    ],
    alternates: { canonical: `/surah/1/al-fatiha` },
    openGraph: {
      title: "Surah Al-Fatiha (الفاتحة) — The Opening",
      description: "Read Surah Al-Fatiha in English transliteration with Tajweed colour coding. 7 verses, Meccan.",
      url: `/surah/1/al-fatiha`,
      type: "article",
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Al-Fatiha</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">الفاتحة</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Al-Fatiha</h2>
        <p className="text-lg text-secondary italic mb-4">The Opening</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Al-Fatiha with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 1
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Al-Fatiha is Special</h3>
          <p className="text-secondary leading-relaxed">Essential for daily prayer; contains the seven oft-repeated verses (Al-Mathani).</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">1</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Opening</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/1" className="text-accent hover:underline">
                  Page 1 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Al-Fatiha at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
