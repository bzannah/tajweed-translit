...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah At-Tin (التين) — The Fig | TajweedTranslit',
    description: 'Read Surah At-Tin (The Fig) — 8 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah At-Tin transliteration',
      'Surah 95 tajweed',
      'At-Tin meaning',
      'Quran at-tin transliteration',
      'learn quran at-tin',
      'quran recitation at-tin',
      'tajweed at-tin',
    ],
    alternates: { canonical: '/surah/95/at-tin' },
    openGraph: {
      title: 'Surah At-Tin (التين) — The Fig',
      description: 'Read Surah At-Tin in English transliteration with Tajweed colour coding. 8 verses, Meccan.',
      url: '/surah/95/at-tin',
      type: 'article',
    },
  };
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah At-Tin</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">التين</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah At-Tin</h2>
        <p className="text-lg text-secondary italic mb-4">The Fig</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah At-Tin with Tajweed →
          </Link>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah At-Tin</h3>
          <p className="text-secondary leading-relaxed">States that humans were created in the best of forms.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah At-Tin is Special</h3>
          <p className="text-secondary leading-relaxed">Contains the verse: "Indeed, the most righteous will be in gardens of eternity."</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">95</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Fig</dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah At-Tin at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
