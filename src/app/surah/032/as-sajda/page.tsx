...
export async function generateStaticParams() {
  return [{ number: "032", slug: "as-sajda" }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Surah As-Sajda (السجدة) — The Prostration | TajweedTranslit",
    description: "Read Surah As-Sajda (The Prostration) — 30 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.",
    keywords: [
      "Surah As-Sajda transliteration",
      "Surah 32 tajweed",
      "As-Sajda meaning",
      "Quran as-sajda transliteration",
      "learn quran as-sajda",
      "quran recitation as-sajda",
      "tajweed as-sajda",
    ],
    alternates: { canonical: `/surah/32/as-sajda` },
    openGraph: {
      title: "Surah As-Sajda (السجدة) — The Prostration",
      description: "Read Surah As-Sajda in English transliteration with Tajweed colour coding. 30 verses, Meccan.",
      url: `/surah/32/as-sajda`,
      type: "article",
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah As-Sajda</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">السجدة</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah As-Sajda</h2>
        <p className="text-lg text-secondary italic mb-4">The Prostration</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah As-Sajda with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 833
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah As-Sajda</h3>
          <p className="text-secondary leading-relaxed">One of five surahs before which sajdah (prostration) is recited.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah As-Sajda is Special</h3>
          <p className="text-secondary leading-relaxed">One of the five surahs of sajdah; recommended to recite on Laylat al-Qadr.</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">32</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Prostration</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/833" className="text-accent hover:underline">
                  Page 833 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah As-Sajda at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
        ...
        <section className="grid grid-cols-2 gap-4">
          <Link href="/surah/31/luqman" className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">← Previous</span>
            <p className="mt-1 font-semibold text-foreground">Surah Luqman</p>
          </Link>
          <Link href="/surah/33/al-ahzab" className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">Next →</span>
            <p className="mt-1 font-semibold text-foreground">Surah Al-Ahzab</p>
          </Link>
        </section>
