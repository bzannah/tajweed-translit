...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Surah Maryam (مريم) — Mary | TajweedTranslit",
    description: "Read Surah Maryam (Mary) — 98 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.",
    keywords: [
      "Surah Maryam transliteration",
      "Surah 19 tajweed",
      "Maryam meaning",
      "Quran maryam transliteration",
      "learn quran maryam",
      "quran recitation maryam",
      "tajweed maryam",
    ],
    alternates: { canonical: `/surah/19/maryam` },
    openGraph: {
      title: "Surah Maryam (مريم) — Mary",
      description: "Read Surah Maryam in English transliteration with Tajweed colour coding. 98 verses, Meccan.",
      url: `/surah/19/maryam`,
      type: "article",
    },
  };
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Maryam</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">مريم</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Maryam</h2>
        <p className="text-lg text-secondary italic mb-4">Mary</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Maryam with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 613
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah Maryam</h3>
          <p className="text-secondary leading-relaxed">Named after Maryam, this Surah contains her story and the birth of Isa (Jesus).</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Maryam is Special</h3>
          <p className="text-secondary leading-relaxed">One of the few surahs named after a woman; contains Isa speaking in the cradle.</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">Mary</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/613" className="text-accent hover:underline">
                  Page 613 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Maryam at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
