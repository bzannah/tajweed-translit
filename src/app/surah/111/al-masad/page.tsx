...
export async function generateStaticParams() {
  return [{ number: "111", slug: "al-masad" }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Surah Al-Masad (المسدد) — The Palm Fibre | TajweedTranslit",
    description: "Read Surah Al-Masad (The Palm Fibre) — 5 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.",
    keywords: [
      "Surah Al-Masad transliteration",
      "Surah 111 tajweed",
      "Al-Masad meaning",
      "Quran al-masad transliteration",
      "learn quran al-masad",
      "quran recitation al-masad",
      "tajweed al-masad",
    ],
    alternates: { canonical: `/surah/111/al-masad` },
    openGraph: {
      title: "Surah Al-Masad (المسدد) — The Palm Fibre",
      description: "Read Surah Al-Masad in English transliteration with Tajweed colour coding. 5 verses, Meccan.",
      url: `/surah/111/al-masad`,
      type: "article",
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Al-Masad</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">المسدد</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Al-Masad</h2>
        <p className="text-lg text-secondary italic mb-4">The Palm Fibre</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Al-Masad with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 1225
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah Al-Masad</h3>
          <p className="text-secondary leading-relaxed">Curses Abu Lahab and his wife — the fiercest opponents of the Prophet.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Al-Masad is Special</h3>
          <p className="text-secondary leading-relaxed">The only surah that explicitly names and curses a specific individual.</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Palm Fibre</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/1225" className="text-accent hover:underline">
                  Page 1225 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Al-Masad at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
