...
export async function generateStaticParams() {
  return [{ number: '074', slug: 'al-muddaththir' }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah Al-Muddaththir (المدثر) — The Cloaked One | TajweedTranslit',
    description: 'Read Surah Al-Muddaththir (The Cloaked One) — 56 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah Al-Muddaththir transliteration',
      'Surah 74 tajweed',
      'Al-Muddaththir meaning',
      'Quran al-muddaththir transliteration',
      'learn quran al-muddaththir',
      'quran recitation al-muddaththir',
      'tajweed al-muddaththir',
    ],
    alternates: { canonical: '/surah/74/al-muddaththir' },
    openGraph: {
      title: 'Surah Al-Muddaththir (المدثر) — The Cloaked One',
      description: 'Read Surah Al-Muddaththir in English transliteration with Tajweed colour coding. 56 verses, Meccan.',
      url: '/surah/74/al-muddaththir',
      type: 'article',
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Al-Muddaththir</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">المدثر</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Al-Muddaththir</h2>
        <p className="text-lg text-secondary italic mb-4">The Cloaked One</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Al-Muddaththir with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 1153
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah Al-Muddaththir</h3>
          <p className="text-secondary leading-relaxed">Commands the Prophet to rise and warn — beginning his mission as the final messenger.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Al-Muddaththir is Special</h3>
          <p className="text-secondary leading-relaxed">This was the first verse revealed to Prophet Muhammad beginning his prophethood.</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">74</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
              <dt className="text-muted text-xs uppercase tracking-wide">Verses</dt>
              <dd className="mt-1 text-lg font-semibold text-foreground">56</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Cloaked One</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/1153" className="text-accent hover:underline">
                  Page 1153 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Al-Muddaththir at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
      ...
      <li class="flex items-center gap-2">
        ...
        <section className="grid grid-cols-2 gap-4">
          <Link href={"/surah/73/" + "al-muzzammil"} className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">← Previous</span>
            <p className="mt-1 font-semibold text-foreground">Surah Al-Muzzammil</p>
          </Link>
          <Link href={"/surah/75/" + "al-qiyama"} className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">Next →</span>
            <p className="mt-1 font-semibold text-foreground">Surah Al-Qiyama</p>
          </Link>
        </section>
