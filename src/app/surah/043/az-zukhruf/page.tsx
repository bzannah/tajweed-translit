...
export async function generateStaticParams() {
  return [{ number: '043', slug: 'az-zukhruf' }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah Az-Zukhruf (الزخرف) — The Gold Adornments | TajweedTranslit',
    description: 'Read Surah Az-Zukhruf (The Gold Adornments) — 89 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah Az-Zukhruf transliteration',
      'Surah 43 tajweed',
      'Az-Zukhruf meaning',
      'Quran az-zukhruf transliteration',
      'learn quran az-zukhruf',
      'quran recitation az-zukhruf',
      'tajweed az-zukhruf',
    ],
    alternates: { canonical: '/surah/43/az-zukhruf' },
    openGraph: {
      title: 'Surah Az-Zukhruf (الزخرف) — The Gold Adornments',
      description: 'Read Surah Az-Zukhruf in English transliteration with Tajweed colour coding. 89 verses, Meccan.',
      url: '/surah/43/az-zukhruf',
      type: 'article',
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Az-Zukhruf</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">الزخرف</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Az-Zukhruf</h2>
        <p className="text-lg text-secondary italic mb-4">The Gold Adornments</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Az-Zukhruf with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 981
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah Az-Zukhruf</h3>
          <p className="text-secondary leading-relaxed">Warns against the decorative false beliefs of the disbelievers.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Az-Zukhruf is Special</h3>
          <p className="text-secondary leading-relaxed">Contains the verse: "He [Musa] said: Do you see what you call upon besides Allah?"</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">43</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Gold Adornments</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/981" className="text-accent hover:underline">
                  Page 981 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Az-Zukhruf at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
