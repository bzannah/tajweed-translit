...
export async function generateStaticParams() {
  return [{ number: '002', slug: 'al-baqara' }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah Al-Baqara (البقرة) — The Cow | TajweedTranslit',
    description: 'Read Surah Al-Baqara (The Cow) — 286 verses, Medinan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah Al-Baqara transliteration',
      'Surah 2 tajweed',
      'Al-Baqara meaning',
      'Quran al-baqara transliteration',
      'learn quran al-baqara',
      'quran recitation al-baqara',
      'tajweed al-baqara',
    ],
    alternates: { canonical: '/surah/2/al-baqara' },
    openGraph: {
      title: 'Surah Al-Baqara (البقرة) — The Cow',
      description: 'Read Surah Al-Baqara in English transliteration with Tajweed colour coding. 286 verses, Medinan.',
      url: '/surah/2/al-baqara',
      type: 'article',
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Al-Baqara</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">البقرة</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Al-Baqara</h2>
        <p className="text-lg text-secondary italic mb-4">The Cow</p>
        <div className="flex flex-wrap justify-center items-center gap-4 text-sm text-muted">
          <span>🏙️ Medinan Revelation</span>
          <span>•</span>
          <span>286 verses</span>
          <span>•</span>
          <span>Page 7</span>
        </div>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Al-Baqara with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 7
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah Al-Baqara</h3>
          <p className="text-secondary leading-relaxed">The longest Surah of the Quran, Al-Baqara covers foundational rulings, stories of previous prophets, and the qualities of the righteous. It was revealed over 8–9 years.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Al-Baqara is Special</h3>
          <p className="text-secondary leading-relaxed">Contains Ayat al-Kursi (the Throne Verse) — the greatest verse in the Quran.</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">2</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
              <dt className="text-muted text-xs uppercase tracking-wide">Verses</dt>
              <dd className="mt-1 text-lg font-semibold text-foreground">286</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Cow</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/7" className="text-accent hover:underline">
                  Page 7 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Al-Baqara at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
      ...
      <li class="flex items-center gap-2">
        ...
        <section className="grid grid-cols-2 gap-4">
          <Link href={"/surah/1/" + "al-fatiha"} className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">← Previous</span>
            <p className="mt-1 font-semibold text-foreground">Surah Al-Fatiha</p>
          </Link>
          <Link href={"/surah/3/" + "al-imran"} className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">Next →</span>
            <p className="mt-1 font-semibold text-foreground">Surah Al-Imran</p>
          </Link>
        </section>
