...
export async function generateStaticParams() {
  return [{ number: '094', slug: 'ash-sharh' }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah Ash-Sharh (الشرح) — The Relief | TajweedTranslit',
    description: 'Read Surah Ash-Sharh (The Relief) — 8 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah Ash-Sharh transliteration',
      'Surah 94 tajweed',
      'Ash-Sharh meaning',
      'Quran ash-sharh transliteration',
      'learn quran ash-sharh',
      'quran recitation ash-sharh',
      'tajweed ash-sharh',
    ],
    alternates: { canonical: '/surah/94/ash-sharh' },
    openGraph: {
      title: 'Surah Ash-Sharh (الشرح) — The Relief',
      description: 'Read Surah Ash-Sharh in English transliteration with Tajweed colour coding. 8 verses, Meccan.',
      url: '/surah/94/ash-sharh',
      type: 'article',
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Ash-Sharh</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">الشرح</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Ash-Sharh</h2>
        <p className="text-lg text-secondary italic mb-4">The Relief</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Ash-Sharh with Tajweed →
          </Link>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah Ash-Sharh</h3>
          <p className="text-secondary leading-relaxed">Brings comfort and expands the chest of the Prophet, raising his status.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Ash-Sharh is Special</h3>
          <p className="text-secondary leading-relaxed">Contains the famous verse: "Indeed, with hardship comes ease."</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">94</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Relief</dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Ash-Sharh at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
