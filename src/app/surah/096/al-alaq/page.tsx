...
export async function generateStaticParams() {
  return [{ number: "096", slug: "al-alaq" }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata {
  ...
  return {
    title: "Surah Al-Alaq (العلق) — The Clot | TajweedTranslit",
    description: "Read Surah Al-Alaq (The Clot) — 19 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.",
    keywords: [
      "Surah Al-Alaq transliteration",
      "Surah 96 tajweed",
      "Al-Alaq meaning",
      "Quran al-alaq transliteration",
      "learn quran al-alaq",
      "quran recitation al-alaq",
      "tajweed al-alaq",
    ],
    alternates: { canonical: `/surah/96/al-alaq` },
    openGraph: {
      title: "Surah Al-Alaq (العلق) — The Clot",
      description: "Read Surah Al-Alaq in English transliteration with Tajweed colour coding. 19 verses, Meccan.",
      url: `/surah/96/al-alaq`,
      type: "article",
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground"
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb"
        <ol className="flex items-center gap-2 text-muted"
          ...
          <li/</li
          <li className="text-foreground" aria-current="page"Surah Al-Alaq</li
        </ol
      </nav
      ...
      <header className="px-4 py-12 text-center"
        ...
        <h1 className="font-brand text-4xl text-accent mb-2"العلق</h1
        <h2 className="font-brand text-2xl text-foreground mb-1"Surah Al-Alaq</h2
        <p className="text-lg text-secondary italic mb-4"The Clot</p
        ...
        <div className="mt-8"
          <Link
            ...
            Read Surah Al-Alaq with Tajweed →
          </Link
          <p className="mt-2 text-xs text-muted"
            Colour-coded transliteration · Page 1197
          </p
        </div
      </header
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12"
        ...
        {/* About */}
        <section
          <h3 className="font-brand text-xl text-accent mb-4"About Surah Al-Alaq</h3
          <p className="text-secondary leading-relaxed"Contains the first verses revealed to Prophet Muhammad — &#39;Read in the name of your Lord.&#39;</p
        </section

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6"
          <h3 className="font-brand text-lg text-accent mb-3"Why Surah Al-Alaq is Special</h3
          <p className="text-secondary leading-relaxed"The first surah revealed to Prophet Muhammad — the command to read in the name of Allah.</p
        </section
        ...
        <section
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm"
            ...
            <div className="rounded-lg border border-border bg-surface p-4"
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic"The Clot</dd
            </div
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2"
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground"
                <Link href="/page/1197" className="text-accent hover:underline"
                  Page 1197 →
                </Link
              </dd
            </div
        ...
        <section
          ...
          <p className="text-sm text-secondary mb-4"
            When reading Surah Al-Alaq at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p
        ...
        <section className="grid grid-cols-2 gap-4"
          <Link href="/surah/95/at-tin" className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors"
            <span className="text-xs text-muted"← Previous</span
            <p className="mt-1 font-semibold text-foreground"Surah At-Tin</p
          </Link
