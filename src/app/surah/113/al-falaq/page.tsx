...
export async function generateStaticParams() {
  return [{ number: '113', slug: 'al-falaq' }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah Al-Falaq (الفلق) — The Daybreak | TajweedTranslit',
    description: 'Read Surah Al-Falaq (The Daybreak) — 5 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah Al-Falaq transliteration',
      'Surah 113 tajweed',
      'Al-Falaq meaning',
      'Quran al-falaq transliteration',
      'learn quran al-falaq',
      'quran recitation al-falaq',
      'tajweed al-falaq',
    ],
    alternates: { canonical: '/surah/113/al-falaq' },
    openGraph: {
      title: 'Surah Al-Falaq (الفلق) — The Daybreak',
      description: 'Read Surah Al-Falaq in English transliteration with Tajweed colour coding. 5 verses, Meccan.',
      url: '/surah/113/al-falaq',
      type: 'article',
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Al-Falaq</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">الفلق</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Al-Falaq</h2>
        <p className="text-lg text-secondary italic mb-4">The Daybreak</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Al-Falaq with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 1229
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah Al-Falaq</h3>
          <p className="text-secondary leading-relaxed">Seeks Allah's protection from the evil of what He created, from darkness, and from witchcraft.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Al-Falaq is Special</h3>
          <p className="text-secondary leading-relaxed">Recited with Al-Falaq and Al-Ikhlas for seeking protection from evil and envy.</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">113</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Daybreak</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/1229" className="text-accent hover:underline">
                  Page 1229 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Al-Falaq at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
      ...
      <li class="flex items-center gap-2">
        ...
        <section className="grid grid-cols-2 gap-4">
          <Link href={"/surah/112/" + "al-ikhlas"} className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">← Previous</span>
            <p className="mt-1 font-semibold text-foreground">Surah Al-Ikhlas</p>
          </Link>
          <Link href={"/surah/114/" + "an-nas"} className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">Next →</span>
            <p className="mt-1 font-semibold text-foreground">Surah An-Nas</p>
          </Link>
        </section>
