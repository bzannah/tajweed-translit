...
export async function generateStaticParams() {
  return [{ number: "081", slug: "at-takwir" }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata {
  ...
  return {
    title: "Surah At-Takwir (التكوير) — The Overthrowing | TajweedTranslit",
    description: "Read Surah At-Takwir (The Overthrowing) — 29 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.",
    keywords: [
      "Surah At-Takwir transliteration",
      "Surah 81 tajweed",
      "At-Takwir meaning",
      "Quran at-takwir transliteration",
      "learn quran at-takwir",
      "quran recitation at-takwir",
      "tajweed at-takwir",
    ],
    alternates: { canonical: `/surah/81/at-takwir` },
    openGraph: {
      title: "Surah At-Takwir (التكوير) — The Overthrowing",
      description: "Read Surah At-Takwir in English transliteration with Tajweed colour coding. 29 verses, Meccan.",
      url: `/surah/81/at-takwir`,
      type: "article",
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground"
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb"
        <ol className="flex items-center gap-2 text-muted"
          ...
          <li/</li
          <li className="text-foreground" aria-current="page"Surah At-Takwir</li
        </ol
      </nav
      ...
      <header className="px-4 py-12 text-center"
        ...
        <h1 className="font-brand text-4xl text-accent mb-2"التكوير</h1
        <h2 className="font-brand text-2xl text-foreground mb-1"Surah At-Takwir</h2
        <p className="text-lg text-secondary italic mb-4"The Overthrowing</p
        ...
        <div className="mt-8"
          <Link
            ...
            Read Surah At-Takwir with Tajweed →
          </Link
          <p className="mt-2 text-xs text-muted"
            Colour-coded transliteration · Page 1175
          </p
        </div
      </header
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12"
        ...
        {/* About */}
        <section
          <h3 className="font-brand text-xl text-accent mb-4"About Surah At-Takwir</h3
          <p className="text-secondary leading-relaxed"Describes the cosmic events of the Day of Judgment.</p
        </section

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6"
          <h3 className="font-brand text-lg text-accent mb-3"Why Surah At-Takwir is Special</h3
          <p className="text-secondary leading-relaxed"The surah that describes the complete upheaval of the universe at resurrection.</p
        </section
        ...
        <section
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm"
            <div className="rounded-lg border border-border bg-surface p-4"
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground"81</dd
            </div
            <div className="rounded-lg border border-border bg-surface p-4"
            ...
            <div className="rounded-lg border border-border bg-surface p-4"
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic"The Overthrowing</dd
            </div
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2"
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground"
                <Link href="/page/1175" className="text-accent hover:underline"
                  Page 1175 →
                </Link
              </dd
            </div
        ...
        <section
          ...
          <p className="text-sm text-secondary mb-4"
            When reading Surah At-Takwir at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p
