...
export async function generateStaticParams() {
  return [{ number: "099", slug: "az-zalzala" }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Surah Az-Zalzala (الزلزلة) — The Earthquake | TajweedTranslit",
    description: "Read Surah Az-Zalzala (The Earthquake) — 8 verses, Medinan revelation. English transliteration with expert Tajweed colour coding. Free online reader.",
    keywords: [
      "Surah Az-Zalzala transliteration",
      "Surah 99 tajweed",
      "Az-Zalzala meaning",
      "Quran az-zalzala transliteration",
      "learn quran az-zalzala",
      "quran recitation az-zalzala",
      "tajweed az-zalzala",
    ],
    alternates: { canonical: `/surah/99/az-zalzala` },
    openGraph: {
      title: "Surah Az-Zalzala (الزلزلة) — The Earthquake",
      description: "Read Surah Az-Zalzala in English transliteration with Tajweed colour coding. 8 verses, Medinan.",
      url: `/surah/99/az-zalzala`,
      type: "article",
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Az-Zalzala</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">الزلزلة</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Az-Zalzala</h2>
        <p className="text-lg text-secondary italic mb-4">The Earthquake</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Az-Zalzala with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 1201
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah Az-Zalzala</h3>
          <p className="text-secondary leading-relaxed">Describes the earthquake of the Day of Judgment when the earth reveals its burdens.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Az-Zalzala is Special</h3>
          <p className="text-secondary leading-relaxed">Reciting this Surah in Salah causes the mountains to testify for the reciter on the Day of Judgment.</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Earthquake</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/1201" className="text-accent hover:underline">
                  Page 1201 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Az-Zalzala at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
        ...
        <section className="grid grid-cols-2 gap-4">
          ...
          <Link href="/surah/100/al-adiyat" className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">Next →</span>
            <p className="mt-1 font-semibold text-foreground">Surah Al-Adiyat</p>
          </Link>
        </section>
