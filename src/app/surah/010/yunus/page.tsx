    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        <section>
          ...
          <p className="text-secondary leading-relaxed">Contains the story of the prophet Yunus — swallowed by a great fish, and his people later repenting.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Yunus is Special</h3>
          <p className="text-secondary leading-relaxed">Contains: 'Indeed, Allah does not forgive associating partners with Him.'</p>
        </section>
