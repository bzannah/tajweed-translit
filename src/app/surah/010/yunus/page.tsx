...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah Yunus (يونس) — Jonah | TajweedTranslit',
    description: 'Read Surah Yunus (Jonah) — 109 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah Yunus transliteration',
      'Surah 10 tajweed',
      'Yunus meaning',
      'Quran yunus transliteration',
      'learn quran yunus',
      'quran recitation yunus',
      'tajweed yunus',
    ],
    alternates: { canonical: '/surah/10/yunus' },
    openGraph: {
      title: 'Surah Yunus (يونس) — Jonah',
      description: 'Read Surah Yunus in English transliteration with Tajweed colour coding. 109 verses, Meccan.',
      url: '/surah/10/yunus',
      type: 'article',
    },
  };
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Yunus</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">يونس</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Yunus</h2>
        <p className="text-lg text-secondary italic mb-4">Jonah</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Yunus with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 419
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah Yunus</h3>
          <p className="text-secondary leading-relaxed">Contains the story of the prophet Yunus — how he was swallowed by a great fish and how his people later repented.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Yunus is Special</h3>
          <p className="text-secondary leading-relaxed">Contains the famous verse: "Indeed, Allah does not forgive associating partners with Him."</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">10</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">Jonah</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/419" className="text-accent hover:underline">
                  Page 419 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Yunus at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
      ...
      <li class="flex items-center gap-2">
        ...
        <section className="grid grid-cols-2 gap-4">
          ...
          <Link href={"/surah/11/" + "hud"} className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">Next →</span>
            <p className="mt-1 font-semibold text-foreground">Surah Hud</p>
          </Link>
        </section>
