...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Surah At-Tur (الطور) — The Mount | TajweedTranslit",
    description: "Read Surah At-Tur (The Mount) — 49 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.",
    keywords: [
      "Surah At-Tur transliteration",
      "Surah 52 tajweed",
      "At-Tur meaning",
      "Quran at-tur transliteration",
      "learn quran at-tur",
      "quran recitation at-tur",
      "tajweed at-tur",
    ],
    alternates: { canonical: `/surah/52/at-tur` },
    openGraph: {
      title: "Surah At-Tur (الطور) — The Mount",
      description: "Read Surah At-Tur in English transliteration with Tajweed colour coding. 49 verses, Meccan.",
      url: `/surah/52/at-tur`,
      type: "article",
    },
  };
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah At-Tur</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">الطور</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah At-Tur</h2>
        <p className="text-lg text-secondary italic mb-4">The Mount</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah At-Tur with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 1049
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah At-Tur</h3>
          <p className="text-secondary leading-relaxed">Describes the Mountain of Sinai where Musa spoke to Allah.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah At-Tur is Special</h3>
          <p className="text-secondary leading-relaxed">Named after the mountain where Musa spoke to Allah — a symbol of divine revelation.</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Mount</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/1049" className="text-accent hover:underline">
                  Page 1049 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah At-Tur at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
        ...
        <section className="grid grid-cols-2 gap-4">
          <Link href="/surah/51/adh-dhariyat" className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">← Previous</span>
            <p className="mt-1 font-semibold text-foreground">Surah Adh-Dhariyat</p>
          </Link>
