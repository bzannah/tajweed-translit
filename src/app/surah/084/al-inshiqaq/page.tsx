...
export async function generateStaticParams() {
  return [{ number: '084', slug: 'al-inshiqaq' }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah Al-Inshiqaq (الانشقاق) — The Sundering | TajweedTranslit',
    description: 'Read Surah Al-Inshiqaq (The Sundering) — 25 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah Al-Inshiqaq transliteration',
      'Surah 84 tajweed',
      'Al-Inshiqaq meaning',
      'Quran al-inshiqaq transliteration',
      'learn quran al-inshiqaq',
      'quran recitation al-inshiqaq',
      'tajweed al-inshiqaq',
    ],
    alternates: { canonical: '/surah/84/al-inshiqaq' },
    openGraph: {
      title: 'Surah Al-Inshiqaq (الانشقاق) — The Sundering',
      description: 'Read Surah Al-Inshiqaq in English transliteration with Tajweed colour coding. 25 verses, Meccan.',
      url: '/surah/84/al-inshiqaq',
      type: 'article',
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Al-Inshiqaq</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">الانشقاق</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Al-Inshiqaq</h2>
        <p className="text-lg text-secondary italic mb-4">The Sundering</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Al-Inshiqaq with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 1181
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah Al-Inshiqaq</h3>
          <p className="text-secondary leading-relaxed">Describes the Day when the earth is stretched out and casts out what is within it.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Al-Inshiqaq is Special</h3>
          <p className="text-secondary leading-relaxed">Contains the verse: "When the earth is stretched out and casts out what is within it."</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">84</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
              <dt className="text-muted text-xs uppercase tracking-wide">Verses</dt>
              <dd className="mt-1 text-lg font-semibold text-foreground">25</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Sundering</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/1181" className="text-accent hover:underline">
                  Page 1181 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Al-Inshiqaq at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
      ...
      <li class="flex items-center gap-2">
        ...
        <section className="grid grid-cols-2 gap-4">
          <Link href={"/surah/83/" + "al-mutaffifin"} className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">← Previous</span>
            <p className="mt-1 font-semibold text-foreground">Surah Al-Mutaffifin</p>
          </Link>
          <Link href={"/surah/85/" + "al-buruj"} className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">Next →</span>
            <p className="mt-1 font-semibold text-foreground">Surah Al-Buruj</p>
          </Link>
        </section>
