...
export async function generateStaticParams() {
  return [{ number: '077', slug: 'al-mursalat' }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah Al-Mursalat (المرسلات) — The Emissaries | TajweedTranslit',
    description: 'Read Surah Al-Mursalat (The Emissaries) — 50 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah Al-Mursalat transliteration',
      'Surah 77 tajweed',
      'Al-Mursalat meaning',
      'Quran al-mursalat transliteration',
      'learn quran al-mursalat',
      'quran recitation al-mursalat',
      'tajweed al-mursalat',
    ],
    alternates: { canonical: '/surah/77/al-mursalat' },
    openGraph: {
      title: 'Surah Al-Mursalat (المرسلات) — The Emissaries',
      description: 'Read Surah Al-Mursalat in English transliteration with Tajweed colour coding. 50 verses, Meccan.',
      url: '/surah/77/al-mursalat',
      type: 'article',
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Al-Mursalat</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">المرسلات</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Al-Mursalat</h2>
        <p className="text-lg text-secondary italic mb-4">The Emissaries</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Al-Mursalat with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 1163
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah Al-Mursalat</h3>
          <p className="text-secondary leading-relaxed">Describes the angels sent with divine commands and the Day of Judgment.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Al-Mursalat is Special</h3>
          <p className="text-secondary leading-relaxed">Contains the famous verse: "By the winds sent forth in gusts."</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">50</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Emissaries</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/1163" className="text-accent hover:underline">
                  Page 1163 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Al-Mursalat at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
