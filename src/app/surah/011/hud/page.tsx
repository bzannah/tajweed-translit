...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Surah Hud (هود) — Hud | TajweedTranslit",
    description: "Read Surah Hud (Hud) — 123 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.",
    keywords: [
      "Surah Hud transliteration",
      "Surah 11 tajweed",
      "Hud meaning",
      "Quran hud transliteration",
      "learn quran hud",
      "quran recitation hud",
      "tajweed hud",
    ],
    alternates: { canonical: `/surah/11/hud` },
    openGraph: {
      title: "Surah Hud (هود) — Hud",
      description: "Read Surah Hud in English transliteration with Tajweed colour coding. 123 verses, Meccan.",
      url: `/surah/11/hud`,
      type: "article",
    },
  };
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Hud</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">هود</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Hud</h2>
        <p className="text-lg text-secondary italic mb-4">Hud</p>
        <div className="flex flex-wrap justify-center items-center gap-4 text-sm text-muted">
          <span>🏔️ Meccan Revelation</span>
          <span>•</span>
          <span>123 verses</span>
          <span>•</span>
          <span>Page 445</span>
        </div>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Hud with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 445
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">123</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">Hud</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/445" className="text-accent hover:underline">
                  Page 445 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Hud at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
