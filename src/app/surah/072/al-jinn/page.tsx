...
export async function generateStaticParams() {
  return [{ number: '072', slug: 'al-jinn' }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah Al-Jinn (الجن) — The Jinn | TajweedTranslit',
    description: 'Read Surah Al-Jinn (The Jinn) — 28 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah Al-Jinn transliteration',
      'Surah 72 tajweed',
      'Al-Jinn meaning',
      'Quran al-jinn transliteration',
      'learn quran al-jinn',
      'quran recitation al-jinn',
      'tajweed al-jinn',
    ],
    alternates: { canonical: '/surah/72/al-jinn' },
    openGraph: {
      title: 'Surah Al-Jinn (الجن) — The Jinn',
      description: 'Read Surah Al-Jinn in English transliteration with Tajweed colour coding. 28 verses, Meccan.',
      url: '/surah/72/al-jinn',
      type: 'article',
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Al-Jinn</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">الجن</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Al-Jinn</h2>
        <p className="text-lg text-secondary italic mb-4">The Jinn</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Al-Jinn with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 1147
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah Al-Jinn</h3>
          <p className="text-secondary leading-relaxed">Reveals that jinn exist and that some accepted Islam when they heard the Quran.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Al-Jinn is Special</h3>
          <p className="text-secondary leading-relaxed">The only surah in which the jinn are described as coming to the Prophet and declaring their faith.</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">72</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Jinn</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/1147" className="text-accent hover:underline">
                  Page 1147 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Al-Jinn at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
      ...
      <li class="flex items-center gap-2">
        ...
        <section className="grid grid-cols-2 gap-4">
          <Link href={"/surah/71/" + "nuh"} className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">← Previous</span>
            <p className="mt-1 font-semibold text-foreground">Surah Nuh</p>
          </Link>
