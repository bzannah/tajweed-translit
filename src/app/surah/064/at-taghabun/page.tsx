...
export async function generateStaticParams() {
  return [{ number: '064', slug: 'at-taghabun' }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah At-Taghabun (التغابن) — The Mutual Disillusion | TajweedTranslit',
    description: 'Read Surah At-Taghabun (The Mutual Disillusion) — 18 verses, Medinan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah At-Taghabun transliteration',
      'Surah 64 tajweed',
      'At-Taghabun meaning',
      'Quran at-taghabun transliteration',
      'learn quran at-taghabun',
      'quran recitation at-taghabun',
      'tajweed at-taghabun',
    ],
    alternates: { canonical: '/surah/64/at-taghabun' },
    openGraph: {
      title: 'Surah At-Taghabun (التغابن) — The Mutual Disillusion',
      description: 'Read Surah At-Taghabun in English transliteration with Tajweed colour coding. 18 verses, Medinan.',
      url: '/surah/64/at-taghabun',
      type: 'article',
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah At-Taghabun</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">التغابن</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah At-Taghabun</h2>
        <p className="text-lg text-secondary italic mb-4">The Mutual Disillusion</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah At-Taghabun with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 1115
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah At-Taghabun</h3>
          <p className="text-secondary leading-relaxed">Addresses the Day when all deeds will be exposed.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah At-Taghabun is Special</h3>
          <p className="text-secondary leading-relaxed">Contains the verse: "He created the heavens and the earth in truth and formed you in the best of forms."</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">64</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Mutual Disillusion</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/1115" className="text-accent hover:underline">
                  Page 1115 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah At-Taghabun at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
