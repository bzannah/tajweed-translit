...
export async function generateStaticParams() {
  return [{ number: '022', slug: 'al-hajj' }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah Al-Hajj (الحج) — The Pilgrimage | TajweedTranslit',
    description: 'Read Surah Al-Hajj (The Pilgrimage) — 78 verses, Medinan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah Al-Hajj transliteration',
      'Surah 22 tajweed',
      'Al-Hajj meaning',
      'Quran al-hajj transliteration',
      'learn quran al-hajj',
      'quran recitation al-hajj',
      'tajweed al-hajj',
    ],
    alternates: { canonical: '/surah/22/al-hajj' },
    openGraph: {
      title: 'Surah Al-Hajj (الحج) — The Pilgrimage',
      description: 'Read Surah Al-Hajj in English transliteration with Tajweed colour coding. 78 verses, Medinan.',
      url: '/surah/22/al-hajj',
      type: 'article',
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Al-Hajj</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">الحج</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Al-Hajj</h2>
        <p className="text-lg text-secondary italic mb-4">The Pilgrimage</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Al-Hajj with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 667
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        <section className="rounded-xl border border-border bg-surface p-6">
          ...
          <p className="text-secondary leading-relaxed">Contains the verse of the Farewell Pilgrimage establishing that the Prophet's authority ends with the Quran.</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Pilgrimage</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/667" className="text-accent hover:underline">
                  Page 667 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Al-Hajj at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
