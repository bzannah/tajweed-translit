...
export async function generateStaticParams() {
  return [{ number: '086', slug: 'at-tariq' }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah At-Tariq (الطارق) — The Morning Star | TajweedTranslit',
    description: 'Read Surah At-Tariq (The Morning Star) — 17 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah At-Tariq transliteration',
      'Surah 86 tajweed',
      'At-Tariq meaning',
      'Quran at-tariq transliteration',
      'learn quran at-tariq',
      'quran recitation at-tariq',
      'tajweed at-tariq',
    ],
    alternates: { canonical: '/surah/86/at-tariq' },
    openGraph: {
      title: 'Surah At-Tariq (الطارق) — The Morning Star',
      description: 'Read Surah At-Tariq in English transliteration with Tajweed colour coding. 17 verses, Meccan.',
      url: '/surah/86/at-tariq',
      type: 'article',
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah At-Tariq</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">الطارق</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah At-Tariq</h2>
        <p className="text-lg text-secondary italic mb-4">The Morning Star</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah At-Tariq with Tajweed →
          </Link>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah At-Tariq</h3>
          <p className="text-secondary leading-relaxed">Emphasizes that humans were created from a clinging substance.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah At-Tariq is Special</h3>
          <p className="text-secondary leading-relaxed">Contains the verse: "Indeed, We created man from a sperm-drop mixture, to test him."</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">86</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Morning Star</dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah At-Tariq at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
