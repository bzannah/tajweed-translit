...
export async function generateStaticParams() {
  return [{ number: '048', slug: 'al-fath' }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah Al-Fath (الفتح) — The Victory | TajweedTranslit',
    description: 'Read Surah Al-Fath (The Victory) — 29 verses, Medinan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah Al-Fath transliteration',
      'Surah 48 tajweed',
      'Al-Fath meaning',
      'Quran al-fath transliteration',
      'learn quran al-fath',
      'quran recitation al-fath',
      'tajweed al-fath',
    ],
    alternates: { canonical: '/surah/48/al-fath' },
    openGraph: {
      title: 'Surah Al-Fath (الفتح) — The Victory',
      description: 'Read Surah Al-Fath in English transliteration with Tajweed colour coding. 29 verses, Medinan.',
      url: '/surah/48/al-fath',
      type: 'article',
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Al-Fath</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">الفتح</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Al-Fath</h2>
        <p className="text-lg text-secondary italic mb-4">The Victory</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Al-Fath with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 1025
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah Al-Fath</h3>
          <p className="text-secondary leading-relaxed">Celebrates the Treaty of Hudaybiyyah — a pivotal moment for the Muslim community.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Al-Fath is Special</h3>
          <p className="text-secondary leading-relaxed">Contains the famous verse: "Muhammad is the Messenger of Allah; and those with him are firm."</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">48</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
              <dt className="text-muted text-xs uppercase tracking-wide">Verses</dt>
              <dd className="mt-1 text-lg font-semibold text-foreground">29</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Victory</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/1025" className="text-accent hover:underline">
                  Page 1025 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Al-Fath at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
      ...
      <li class="flex items-center gap-2">
        ...
        <section className="grid grid-cols-2 gap-4">
          <Link href={"/surah/47/" + "muhammad"} className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">← Previous</span>
            <p className="mt-1 font-semibold text-foreground">Surah Muhammad</p>
          </Link>
          <Link href={"/surah/49/" + "al-hujurat"} className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">Next →</span>
            <p className="mt-1 font-semibold text-foreground">Surah Al-Hujurat</p>
          </Link>
        </section>
