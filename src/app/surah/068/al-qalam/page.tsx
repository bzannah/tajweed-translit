    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        <section className="rounded-xl border border-border bg-surface p-6">
          ...
          <p className="text-secondary leading-relaxed">Contains the famous verse: "The soul and He who proportioned it — then inspired it with its wickedness and its righteousness."</p>
        </section>
