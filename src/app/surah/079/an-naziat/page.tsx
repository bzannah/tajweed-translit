...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    keywords: [
      ...
      "Surah 79 tajweed",
      "An-Nazi'at meaning",
      "Quran an-naziat transliteration",
      "learn quran an-naziat",
      "quran recitation an-naziat",
      "tajweed an-naziat",
    ],
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        <section className="rounded-xl border border-border bg-surface p-6">
          ...
          <p className="text-secondary leading-relaxed">Contains: 'And the mountains are moved and become like tufts of wool.'</p>
        </section>
