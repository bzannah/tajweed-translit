...
export async function generateStaticParams() {
  return [{ number: '091', slug: 'ash-shams' }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah Ash-Shams (الشمس) — The Sun | TajweedTranslit',
    description: 'Read Surah Ash-Shams (The Sun) — 15 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah Ash-Shams transliteration',
      'Surah 91 tajweed',
      'Ash-Shams meaning',
      'Quran ash-shams transliteration',
      'learn quran ash-shams',
      'quran recitation ash-shams',
      'tajweed ash-shams',
    ],
    alternates: { canonical: '/surah/91/ash-shams' },
    openGraph: {
      title: 'Surah Ash-Shams (الشمس) — The Sun',
      description: 'Read Surah Ash-Shams in English transliteration with Tajweed colour coding. 15 verses, Meccan.',
      url: '/surah/91/ash-shams',
      type: 'article',
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Ash-Shams</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">الشمس</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Ash-Shams</h2>
        <p className="text-lg text-secondary italic mb-4">The Sun</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Ash-Shams with Tajweed →
          </Link>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah Ash-Shams</h3>
          <p className="text-secondary leading-relaxed">Swears by the sun and its radiance and addresses the parable of Thamud and their she-camel.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Ash-Shams is Special</h3>
          <p className="text-secondary leading-relaxed">Contains the famous verse: "Blessed is He who, if He willed, could make for you something better."</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">91</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Sun</dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Ash-Shams at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
