...
export async function generateStaticParams() {
  return [{ number: '063', slug: 'al-munafiqun' }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah Al-Munafiqun (المنافقون) — The Hypocrites | TajweedTranslit',
    description: 'Read Surah Al-Munafiqun (The Hypocrites) — 11 verses, Medinan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah Al-Munafiqun transliteration',
      'Surah 63 tajweed',
      'Al-Munafiqun meaning',
      'Quran al-munafiqun transliteration',
      'learn quran al-munafiqun',
      'quran recitation al-munafiqun',
      'tajweed al-munafiqun',
    ],
    alternates: { canonical: '/surah/63/al-munafiqun' },
    openGraph: {
      title: 'Surah Al-Munafiqun (المنافقون) — The Hypocrites',
      description: 'Read Surah Al-Munafiqun in English transliteration with Tajweed colour coding. 11 verses, Medinan.',
      url: '/surah/63/al-munafiqun',
      type: 'article',
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Al-Munafiqun</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">المنافقون</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Al-Munafiqun</h2>
        <p className="text-lg text-secondary italic mb-4">The Hypocrites</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Al-Munafiqun with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 1111
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah Al-Munafiqun</h3>
          <p className="text-secondary leading-relaxed">Exposes the characteristics of hypocrites.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Al-Munafiqun is Special</h3>
          <p className="text-secondary leading-relaxed">Contains the famous hadith qudsi: "When I love My servant, I am his hearing, his sight."</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">63</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Hypocrites</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/1111" className="text-accent hover:underline">
                  Page 1111 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Al-Munafiqun at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
      ...
      <li class="flex items-center gap-2">
        ...
        <section className="grid grid-cols-2 gap-4">
          <Link href={"/surah/62/" + "al-jumua"} className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">← Previous</span>
            <p className="mt-1 font-semibold text-foreground">Surah Al-Jumu'a</p>
          </Link>
          <Link href={"/surah/64/" + "at-taghabun"} className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">Next →</span>
            <p className="mt-1 font-semibold text-foreground">Surah At-Taghabun</p>
          </Link>
        </section>
