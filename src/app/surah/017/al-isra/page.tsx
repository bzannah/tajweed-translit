...
export async function generateStaticParams() {
  return [{ number: '017', slug: 'al-isra' }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah Al-Isra (الإسراء) — The Night Journey | TajweedTranslit',
    description: 'Read Surah Al-Isra (The Night Journey) — 111 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah Al-Isra transliteration',
      'Surah 17 tajweed',
      'Al-Isra meaning',
      'Quran al-isra transliteration',
      'learn quran al-isra',
      'quran recitation al-isra',
      'tajweed al-isra',
    ],
    alternates: { canonical: '/surah/17/al-isra' },
    openGraph: {
      title: 'Surah Al-Isra (الإسراء) — The Night Journey',
      description: 'Read Surah Al-Isra in English transliteration with Tajweed colour coding. 111 verses, Meccan.',
      url: '/surah/17/al-isra',
      type: 'article',
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Al-Isra</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">الإسراء</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Al-Isra</h2>
        <p className="text-lg text-secondary italic mb-4">The Night Journey</p>
        <div className="flex flex-wrap justify-center items-center gap-4 text-sm text-muted">
          <span>🏔️ Meccan Revelation</span>
          <span>•</span>
          <span>111 verses</span>
          <span>•</span>
          <span>Page 567</span>
        </div>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Al-Isra with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 567
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah Al-Isra</h3>
          <p className="text-secondary leading-relaxed">Records the Night Journey (Isra) from Mecca to Jerusalem and the Ascension (Miraj).</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Al-Isra is Special</h3>
          <p className="text-secondary leading-relaxed">Contains the famous command: "No soul shall die except by Allah's permission."</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">17</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
              <dt className="text-muted text-xs uppercase tracking-wide">Verses</dt>
              <dd className="mt-1 text-lg font-semibold text-foreground">111</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Night Journey</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/567" className="text-accent hover:underline">
                  Page 567 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Al-Isra at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
      ...
      <li class="flex items-center gap-2">
        ...
        <section className="grid grid-cols-2 gap-4">
          <Link href={"/surah/16/" + "an-nahl"} className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">← Previous</span>
            <p className="mt-1 font-semibold text-foreground">Surah An-Nahl</p>
          </Link>
          <Link href={"/surah/18/" + "al-kahf"} className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">Next →</span>
            <p className="mt-1 font-semibold text-foreground">Surah Al-Kahf</p>
          </Link>
        </section>
