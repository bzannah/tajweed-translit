...
export async function generateStaticParams() {
  return [{ number: "110", slug: "an-nasr" }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata {
  ...
  return {
    title: "Surah An-Nasr (النصر) — The Divine Support | TajweedTranslit",
    description: "Read Surah An-Nasr (The Divine Support) — 3 verses, Medinan revelation. English transliteration with expert Tajweed colour coding. Free online reader.",
    keywords: [
      "Surah An-Nasr transliteration",
      "Surah 110 tajweed",
      "An-Nasr meaning",
      "Quran an-nasr transliteration",
      "learn quran an-nasr",
      "quran recitation an-nasr",
      "tajweed an-nasr",
    ],
    alternates: { canonical: `/surah/110/an-nasr` },
    openGraph: {
      title: "Surah An-Nasr (النصر) — The Divine Support",
      description: "Read Surah An-Nasr in English transliteration with Tajweed colour coding. 3 verses, Medinan.",
      url: `/surah/110/an-nasr`,
      type: "article",
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground"
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb"
        <ol className="flex items-center gap-2 text-muted"
          ...
          <li/</li
          <li className="text-foreground" aria-current="page"Surah An-Nasr</li
        </ol
      </nav
      ...
      <header className="px-4 py-12 text-center"
        ...
        <h1 className="font-brand text-4xl text-accent mb-2"النصر</h1
        <h2 className="font-brand text-2xl text-foreground mb-1"Surah An-Nasr</h2
        <p className="text-lg text-secondary italic mb-4"The Divine Support</p
        ...
        <div className="mt-8"
          <Link
            ...
            Read Surah An-Nasr with Tajweed →
          </Link
          <p className="mt-2 text-xs text-muted"
            Colour-coded transliteration · Page 1223
          </p
        </div
      </header
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12"
        ...
        {/* About */}
        <section
          <h3 className="font-brand text-xl text-accent mb-4"About Surah An-Nasr</h3
          <p className="text-secondary leading-relaxed"Announces the victory (fath) that Allah will grant to Islam — a prediction of the conquest of Mecca.</p
        </section

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6"
          <h3 className="font-brand text-lg text-accent mb-3"Why Surah An-Nasr is Special</h3
          <p className="text-secondary leading-relaxed"When this surah was revealed, the Prophet understood his work was nearing completion.</p
        </section
        ...
        <section
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm"
            ...
            <div className="rounded-lg border border-border bg-surface p-4"
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic"The Divine Support</dd
            </div
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2"
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground"
                <Link href="/page/1223" className="text-accent hover:underline"
                  Page 1223 →
                </Link
              </dd
            </div
        ...
        <section
          ...
          <p className="text-sm text-secondary mb-4"
            When reading Surah An-Nasr at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p
        ...
        <section className="grid grid-cols-2 gap-4"
          <Link href="/surah/109/al-kafirun" className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors"
            ...
            <p className="mt-1 font-semibold text-foreground"Surah Al-Kafirun</p
          </Link
