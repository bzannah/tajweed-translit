...
export async function generateStaticParams() {
  return [{ number: '075', slug: 'al-qiyama' }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah Al-Qiyama (القيامة) — The Resurrection | TajweedTranslit',
    description: 'Read Surah Al-Qiyama (The Resurrection) — 40 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah Al-Qiyama transliteration',
      'Surah 75 tajweed',
      'Al-Qiyama meaning',
      'Quran al-qiyama transliteration',
      'learn quran al-qiyama',
      'quran recitation al-qiyama',
      'tajweed al-qiyama',
    ],
    alternates: { canonical: '/surah/75/al-qiyama' },
    openGraph: {
      title: 'Surah Al-Qiyama (القيامة) — The Resurrection',
      description: 'Read Surah Al-Qiyama in English transliteration with Tajweed colour coding. 40 verses, Meccan.',
      url: '/surah/75/al-qiyama',
      type: 'article',
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Al-Qiyama</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">القيامة</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Al-Qiyama</h2>
        <p className="text-lg text-secondary italic mb-4">The Resurrection</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Al-Qiyama with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 1157
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah Al-Qiyama</h3>
          <p className="text-secondary leading-relaxed">Addresses the doubters of the resurrection.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Al-Qiyama is Special</h3>
          <p className="text-secondary leading-relaxed">Contains the verse: "Does man not remember that We created him before when he was nothing?"</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">75</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
              <dt className="text-muted text-xs uppercase tracking-wide">Verses</dt>
              <dd className="mt-1 text-lg font-semibold text-foreground">40</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Resurrection</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/1157" className="text-accent hover:underline">
                  Page 1157 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Al-Qiyama at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
      ...
      <li class="flex items-center gap-2">
        ...
        <section className="grid grid-cols-2 gap-4">
          <Link href={"/surah/74/" + "al-muddaththir"} className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">← Previous</span>
            <p className="mt-1 font-semibold text-foreground">Surah Al-Muddaththir</p>
          </Link>
          <Link href={"/surah/76/" + "al-insan"} className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">Next →</span>
            <p className="mt-1 font-semibold text-foreground">Surah Al-Insan</p>
          </Link>
        </section>
