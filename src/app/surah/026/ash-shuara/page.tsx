...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    keywords: [
      ...
      "Surah 26 tajweed",
      "Ash-Shu'ara meaning",
      "Quran ash-shuara transliteration",
      "learn quran ash-shuara",
      "quran recitation ash-shuara",
      "tajweed ash-shuara",
    ],
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        <section className="rounded-xl border border-border bg-surface p-6">
          ...
          <p className="text-secondary leading-relaxed">Contains: &#39;And your Lord is the Most Blessed and Exalted.'</p>
        </section>
