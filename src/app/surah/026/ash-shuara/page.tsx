...
export async function generateStaticParams() {
  return [{ number: '026', slug: 'ash-shuara' }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah Ash-Shu'ara (الشعراء) — The Poets | TajweedTranslit',
    description: 'Read Surah Ash-Shu'ara (The Poets) — 227 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah Ash-Shu'ara transliteration',
      'Surah 26 tajweed',
      'Ash-Shu'ara meaning',
      'Quran ash-shu'ara transliteration',
      'learn quran ash-shu'ara',
      'quran recitation ash-shu'ara',
      'tajweed ash-shu'ara',
    ],
    alternates: { canonical: '/surah/26/ash-shuara' },
    openGraph: {
      title: 'Surah Ash-Shu'ara (الشعراء) — The Poets',
      description: 'Read Surah Ash-Shu'ara in English transliteration with Tajweed colour coding. 227 verses, Meccan.',
      url: '/surah/26/ash-shuara',
      type: 'article',
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Ash-Shu'ara</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">الشعراء</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Ash-Shu'ara</h2>
        <p className="text-lg text-secondary italic mb-4">The Poets</p>
        <div className="flex flex-wrap justify-center items-center gap-4 text-sm text-muted">
          <span>🏔️ Meccan Revelation</span>
          <span>•</span>
          <span>227 verses</span>
          <span>•</span>
          <span>Page 737</span>
        </div>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Ash-Shu'ara with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 737
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah Ash-Shu'ara</h3>
          <p className="text-secondary leading-relaxed">Contains the stories of Musa, Ibrahim, Nuh, Hud, Salih, Lut, and Shu'ayb.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Ash-Shu'ara is Special</h3>
          <p className="text-secondary leading-relaxed">Contains the verse: "And your Lord is the Most Blessed and Exalted."</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">227</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Poets</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/737" className="text-accent hover:underline">
                  Page 737 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Ash-Shu'ara at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
      ...
      <li class="flex items-center gap-2">
        ...
        <section className="grid grid-cols-2 gap-4">
          <Link href={"/surah/25/" + "al-furqan"} className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">← Previous</span>
            <p className="mt-1 font-semibold text-foreground">Surah Al-Furqan</p>
          </Link>
