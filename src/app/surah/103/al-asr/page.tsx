...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Surah Al-Asr (العصر) — The Declining Day | TajweedTranslit",
    description: "Read Surah Al-Asr (The Declining Day) — 3 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.",
    keywords: [
      "Surah Al-Asr transliteration",
      "Surah 103 tajweed",
      "Al-Asr meaning",
      "Quran al-asr transliteration",
      "learn quran al-asr",
      "quran recitation al-asr",
      "tajweed al-asr",
    ],
    alternates: { canonical: `/surah/103/al-asr` },
    openGraph: {
      title: "Surah Al-Asr (العصر) — The Declining Day",
      description: "Read Surah Al-Asr in English transliteration with Tajweed colour coding. 3 verses, Meccan.",
      url: `/surah/103/al-asr`,
      type: "article",
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Al-Asr</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">العصر</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Al-Asr</h2>
        <p className="text-lg text-secondary italic mb-4">The Declining Day</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Al-Asr with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 1209
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah Al-Asr</h3>
          <p className="text-secondary leading-relaxed">States that all of humanity is in loss — except those who believe, do righteous deeds, and enjoin the truth.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Al-Asr is Special</h3>
          <p className="text-secondary leading-relaxed">Ibn Taymiyyah said this is the most comprehensive surah — containing the entire religion.</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">103</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Declining Day</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/1209" className="text-accent hover:underline">
                  Page 1209 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Al-Asr at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
        ...
        <section className="grid grid-cols-2 gap-4">
          <Link href="/surah/102/at-takathur" className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">← Previous</span>
            <p className="mt-1 font-semibold text-foreground">Surah At-Takathur</p>
          </Link>
          <Link href="/surah/104/al-humaza" className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">Next →</span>
            <p className="mt-1 font-semibold text-foreground">Surah Al-Humaza</p>
          </Link>
        </section>
