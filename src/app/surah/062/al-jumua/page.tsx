...
export async function generateStaticParams() {
  return [{ number: '062', slug: 'al-jumua' }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah Al-Jumu'a (الجمعة) — Friday | TajweedTranslit',
    description: 'Read Surah Al-Jumu'a (Friday) — 11 verses, Medinan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah Al-Jumu'a transliteration',
      'Surah 62 tajweed',
      'Al-Jumu'a meaning',
      'Quran al-jumu'a transliteration',
      'learn quran al-jumu'a',
      'quran recitation al-jumu'a',
      'tajweed al-jumu'a',
    ],
    alternates: { canonical: '/surah/62/al-jumua' },
    openGraph: {
      title: 'Surah Al-Jumu'a (الجمعة) — Friday',
      description: 'Read Surah Al-Jumu'a in English transliteration with Tajweed colour coding. 11 verses, Medinan.',
      url: '/surah/62/al-jumua',
      type: 'article',
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Al-Jumu'a</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">الجمعة</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Al-Jumu'a</h2>
        <p className="text-lg text-secondary italic mb-4">Friday</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Al-Jumu'a with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 1109
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah Al-Jumu'a</h3>
          <p className="text-secondary leading-relaxed">Establishes Friday as the day of gathering and rest for Muslims.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Al-Jumu'a is Special</h3>
          <p className="text-secondary leading-relaxed">Establishes Friday as the weekly day of worship for Muslims.</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">62</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">Friday</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/1109" className="text-accent hover:underline">
                  Page 1109 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Al-Jumu'a at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
      ...
      <li class="flex items-center gap-2">
        ...
        <section className="grid grid-cols-2 gap-4">
          ...
          <Link href={"/surah/63/" + "al-munafiqun"} className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">Next →</span>
            <p className="mt-1 font-semibold text-foreground">Surah Al-Munafiqun</p>
          </Link>
        </section>
