...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah Luqman (لقمان) — Luqman | TajweedTranslit',
    description: 'Read Surah Luqman (Luqman) — 34 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah Luqman transliteration',
      'Surah 31 tajweed',
      'Luqman meaning',
      'Quran luqman transliteration',
      'learn quran luqman',
      'quran recitation luqman',
      'tajweed luqman',
    ],
    alternates: { canonical: '/surah/31/luqman' },
    openGraph: {
      title: 'Surah Luqman (لقمان) — Luqman',
      description: 'Read Surah Luqman in English transliteration with Tajweed colour coding. 34 verses, Meccan.',
      url: '/surah/31/luqman',
      type: 'article',
    },
  };
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Luqman</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">لقمان</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Luqman</h2>
        <p className="text-lg text-secondary italic mb-4">Luqman</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Luqman with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 825
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah Luqman</h3>
          <p className="text-secondary leading-relaxed">Named after the wise Luqman, containing his advice to his son.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Luqman is Special</h3>
          <p className="text-secondary leading-relaxed">Contains Luqman's advice: "O my son, do not associate partners with Allah."</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">34</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">Luqman</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/825" className="text-accent hover:underline">
                  Page 825 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Luqman at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
      ...
      <li class="flex items-center gap-2">
        ...
        <section className="grid grid-cols-2 gap-4">
          <Link href={"/surah/30/" + "ar-rum"} className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">← Previous</span>
            <p className="mt-1 font-semibold text-foreground">Surah Ar-Rum</p>
          </Link>
