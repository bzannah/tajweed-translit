...
export async function generateStaticParams() {
  return [{ number: '018', slug: 'al-kahf' }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah Al-Kahf (الكهف) — The Cave | TajweedTranslit',
    description: 'Read Surah Al-Kahf (The Cave) — 110 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah Al-Kahf transliteration',
      'Surah 18 tajweed',
      'Al-Kahf meaning',
      'Quran al-kahf transliteration',
      'learn quran al-kahf',
      'quran recitation al-kahf',
      'tajweed al-kahf',
    ],
    alternates: { canonical: '/surah/18/al-kahf' },
    openGraph: {
      title: 'Surah Al-Kahf (الكهف) — The Cave',
      description: 'Read Surah Al-Kahf in English transliteration with Tajweed colour coding. 110 verses, Meccan.',
      url: '/surah/18/al-kahf',
      type: 'article',
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Al-Kahf</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">الكهف</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Al-Kahf</h2>
        <p className="text-lg text-secondary italic mb-4">The Cave</p>
        <div className="flex flex-wrap justify-center items-center gap-4 text-sm text-muted">
          <span>🏔️ Meccan Revelation</span>
          <span>•</span>
          <span>110 verses</span>
          <span>•</span>
          <span>Page 589</span>
        </div>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Al-Kahf with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 589
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah Al-Kahf</h3>
          <p className="text-secondary leading-relaxed">The Surah of the Cave — containing the stories of the People of the Cave, the man with two gardens, and Musa and Khidr.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Al-Kahf is Special</h3>
          <p className="text-secondary leading-relaxed">Reciting this Surah on Friday brings light for the next eight days.</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">110</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Cave</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/589" className="text-accent hover:underline">
                  Page 589 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Al-Kahf at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
      ...
      <li class="flex items-center gap-2">
        ...
        <section className="grid grid-cols-2 gap-4">
          <Link href={"/surah/17/" + "al-isra"} className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">← Previous</span>
            <p className="mt-1 font-semibold text-foreground">Surah Al-Isra</p>
          </Link>
          <Link href={"/surah/19/" + "maryam"} className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">Next →</span>
            <p className="mt-1 font-semibold text-foreground">Surah Maryam</p>
          </Link>
        </section>
