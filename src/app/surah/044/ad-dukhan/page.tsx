...
export async function generateStaticParams() {
  return [{ number: "044", slug: "ad-dukhan" }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Surah Ad-Dukhan (الدخان) — The Smoke | TajweedTranslit",
    description: "Read Surah Ad-Dukhan (The Smoke) — 59 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.",
    keywords: [
      "Surah Ad-Dukhan transliteration",
      "Surah 44 tajweed",
      "Ad-Dukhan meaning",
      "Quran ad-dukhan transliteration",
      "learn quran ad-dukhan",
      "quran recitation ad-dukhan",
      "tajweed ad-dukhan",
    ],
    alternates: { canonical: `/surah/44/ad-dukhan` },
    openGraph: {
      title: "Surah Ad-Dukhan (الدخان) — The Smoke",
      description: "Read Surah Ad-Dukhan in English transliteration with Tajweed colour coding. 59 verses, Meccan.",
      url: `/surah/44/ad-dukhan`,
      type: "article",
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Ad-Dukhan</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">الدخان</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Ad-Dukhan</h2>
        <p className="text-lg text-secondary italic mb-4">The Smoke</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Ad-Dukhan with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 995
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah Ad-Dukhan</h3>
          <p className="text-secondary leading-relaxed">Describes a smoke that will cover the disbelievers as punishment.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Ad-Dukhan is Special</h3>
          <p className="text-secondary leading-relaxed">Reciting this Surah in Fajr on Friday brings the reward of a whole year of worship.</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">44</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Smoke</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/995" className="text-accent hover:underline">
                  Page 995 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Ad-Dukhan at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
