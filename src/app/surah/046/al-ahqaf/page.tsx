...
export async function generateStaticParams() {
  return [{ number: '046', slug: 'al-ahqaf' }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah Al-Ahqaf (الأحقاف) — The Sand Dunes | TajweedTranslit',
    description: 'Read Surah Al-Ahqaf (The Sand Dunes) — 35 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah Al-Ahqaf transliteration',
      'Surah 46 tajweed',
      'Al-Ahqaf meaning',
      'Quran al-ahqaf transliteration',
      'learn quran al-ahqaf',
      'quran recitation al-ahqaf',
      'tajweed al-ahqaf',
    ],
    alternates: { canonical: '/surah/46/al-ahqaf' },
    openGraph: {
      title: 'Surah Al-Ahqaf (الأحقاف) — The Sand Dunes',
      description: 'Read Surah Al-Ahqaf in English transliteration with Tajweed colour coding. 35 verses, Meccan.',
      url: '/surah/46/al-ahqaf',
      type: 'article',
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Al-Ahqaf</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">الأحقاف</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Al-Ahqaf</h2>
        <p className="text-lg text-secondary italic mb-4">The Sand Dunes</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Al-Ahqaf with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 1007
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah Al-Ahqaf</h3>
          <p className="text-secondary leading-relaxed">Addresses the Thamud people and their prophet Salih.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Al-Ahqaf is Special</h3>
          <p className="text-secondary leading-relaxed">Contains the verse about those whose ears and hearts are sealed.</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">35</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Sand Dunes</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/1007" className="text-accent hover:underline">
                  Page 1007 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Al-Ahqaf at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
      ...
      <li class="flex items-center gap-2">
        ...
        <section className="grid grid-cols-2 gap-4">
          <Link href={"/surah/45/" + "al-jathiya"} className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">← Previous</span>
            <p className="mt-1 font-semibold text-foreground">Surah Al-Jathiya</p>
          </Link>
