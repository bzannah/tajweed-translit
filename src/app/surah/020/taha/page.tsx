...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah Taha (طه) — Ta-Ha | TajweedTranslit',
    description: 'Read Surah Taha (Ta-Ha) — 135 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah Taha transliteration',
      'Surah 20 tajweed',
      'Taha meaning',
      'Quran taha transliteration',
      'learn quran taha',
      'quran recitation taha',
      'tajweed taha',
    ],
    alternates: { canonical: '/surah/20/taha' },
    openGraph: {
      title: 'Surah Taha (طه) — Ta-Ha',
      description: 'Read Surah Taha in English transliteration with Tajweed colour coding. 135 verses, Meccan.',
      url: '/surah/20/taha',
      type: 'article',
    },
  };
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Taha</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">طه</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Taha</h2>
        <p className="text-lg text-secondary italic mb-4">Ta-Ha</p>
        <div className="flex flex-wrap justify-center items-center gap-4 text-sm text-muted">
          <span>🏔️ Meccan Revelation</span>
          <span>•</span>
          <span>135 verses</span>
          <span>•</span>
          <span>Page 627</span>
        </div>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Taha with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 627
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah Taha</h3>
          <p className="text-secondary leading-relaxed">Contains the story of Musa (Moses) from his birth to his mission with Pharaoh.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Taha is Special</h3>
          <p className="text-secondary leading-relaxed">Contains the verse: "Every soul tastes death."</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">135</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">Ta-Ha</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/627" className="text-accent hover:underline">
                  Page 627 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Taha at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
      ...
      <li class="flex items-center gap-2">
        ...
        <section className="grid grid-cols-2 gap-4">
          ...
          <Link href={"/surah/21/" + "al-anbiya"} className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">Next →</span>
            <p className="mt-1 font-semibold text-foreground">Surah Al-Anbiya</p>
          </Link>
        </section>
