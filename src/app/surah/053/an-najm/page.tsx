...
export async function generateStaticParams() {
  return [{ number: '053', slug: 'an-najm' }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah An-Najm (النجم) — The Star | TajweedTranslit',
    description: 'Read Surah An-Najm (The Star) — 62 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah An-Najm transliteration',
      'Surah 53 tajweed',
      'An-Najm meaning',
      'Quran an-najm transliteration',
      'learn quran an-najm',
      'quran recitation an-najm',
      'tajweed an-najm',
    ],
    alternates: { canonical: '/surah/53/an-najm' },
    openGraph: {
      title: 'Surah An-Najm (النجم) — The Star',
      description: 'Read Surah An-Najm in English transliteration with Tajweed colour coding. 62 verses, Meccan.',
      url: '/surah/53/an-najm',
      type: 'article',
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah An-Najm</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">النجم</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah An-Najm</h2>
        <p className="text-lg text-secondary italic mb-4">The Star</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah An-Najm with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 1055
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Star</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/1055" className="text-accent hover:underline">
                  Page 1055 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah An-Najm at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
