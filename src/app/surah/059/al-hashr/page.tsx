...
export async function generateStaticParams() {
  return [{ number: '059', slug: 'al-hashr' }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah Al-Hashr (الحشر) — The Gathering | TajweedTranslit',
    description: 'Read Surah Al-Hashr (The Gathering) — 24 verses, Medinan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah Al-Hashr transliteration',
      'Surah 59 tajweed',
      'Al-Hashr meaning',
      'Quran al-hashr transliteration',
      'learn quran al-hashr',
      'quran recitation al-hashr',
      'tajweed al-hashr',
    ],
    alternates: { canonical: '/surah/59/al-hashr' },
    openGraph: {
      title: 'Surah Al-Hashr (الحشر) — The Gathering',
      description: 'Read Surah Al-Hashr in English transliteration with Tajweed colour coding. 24 verses, Medinan.',
      url: '/surah/59/al-hashr',
      type: 'article',
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Al-Hashr</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">الحشر</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Al-Hashr</h2>
        <p className="text-lg text-secondary italic mb-4">The Gathering</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Al-Hashr with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 1093
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah Al-Hashr</h3>
          <p className="text-secondary leading-relaxed">Addresses the exile of the Banu Nadir tribe and the attributes of Allah.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Al-Hashr is Special</h3>
          <p className="text-secondary leading-relaxed">Contains the verse: "Whatever thing you spend [for charity] — He will replace it."</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">59</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
              <dt className="text-muted text-xs uppercase tracking-wide">Verses</dt>
              <dd className="mt-1 text-lg font-semibold text-foreground">24</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Gathering</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/1093" className="text-accent hover:underline">
                  Page 1093 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Al-Hashr at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
      ...
      <li class="flex items-center gap-2">
        ...
        <section className="grid grid-cols-2 gap-4">
          <Link href={"/surah/58/" + "al-mujadila"} className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            ...
            <p className="mt-1 font-semibold text-foreground">Surah Al-Mujadila</p>
          </Link>
