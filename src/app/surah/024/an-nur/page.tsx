...
export async function generateMetadata({ params }: Props): Promise<Metadata {
  ...
  return {
    title: "Surah An-Nur (النور) — The Light | TajweedTranslit",
    description: "Read Surah An-Nur (The Light) — 64 verses, Medinan revelation. English transliteration with expert Tajweed colour coding. Free online reader.",
    keywords: [
      "Surah An-Nur transliteration",
      "Surah 24 tajweed",
      "An-Nur meaning",
      "Quran an-nur transliteration",
      "learn quran an-nur",
      "quran recitation an-nur",
      "tajweed an-nur",
    ],
    alternates: { canonical: `/surah/24/an-nur` },
    openGraph: {
      title: "Surah An-Nur (النور) — The Light",
      description: "Read Surah An-Nur in English transliteration with Tajweed colour coding. 64 verses, Medinan.",
      url: `/surah/24/an-nur`,
      type: "article",
    },
  };
    ...
    <div className="min-h-screen bg-background text-foreground"
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb"
        <ol className="flex items-center gap-2 text-muted"
          ...
          <li/</li
          <li className="text-foreground" aria-current="page"Surah An-Nur</li
        </ol
      </nav
      ...
      <header className="px-4 py-12 text-center"
        ...
        <h1 className="font-brand text-4xl text-accent mb-2"النور</h1
        <h2 className="font-brand text-2xl text-foreground mb-1"Surah An-Nur</h2
        <p className="text-lg text-secondary italic mb-4"The Light</p
        ...
        <div className="mt-8"
          <Link
            ...
            Read Surah An-Nur with Tajweed →
          </Link
          <p className="mt-2 text-xs text-muted"
            Colour-coded transliteration · Page 703
          </p
        </div
      </header
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12"
        ...
        {/* About */}
        <section
          <h3 className="font-brand text-xl text-accent mb-4"About Surah An-Nur</h3
          <p className="text-secondary leading-relaxed"Covers the incident of slander, laws of modesty, the command of hijab, and rules of evidence.</p
        </section

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6"
          <h3 className="font-brand text-lg text-accent mb-3"Why Surah An-Nur is Special</h3
          <p className="text-secondary leading-relaxed"Contains the command of hijab (24:31).</p
        </section
        ...
        <section
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm"
            ...
            <div className="rounded-lg border border-border bg-surface p-4"
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic"The Light</dd
            </div
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2"
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground"
                <Link href="/page/703" className="text-accent hover:underline"
                  Page 703 →
                </Link
              </dd
            </div
        ...
        <section
          ...
          <p className="text-sm text-secondary mb-4"
            When reading Surah An-Nur at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p
