...
export async function generateStaticParams() {
  return [{ number: '082', slug: 'al-infitar' }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah Al-Infitar (الانفطار) — The Cleaving | TajweedTranslit',
    description: 'Read Surah Al-Infitar (The Cleaving) — 19 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah Al-Infitar transliteration',
      'Surah 82 tajweed',
      'Al-Infitar meaning',
      'Quran al-infitar transliteration',
      'learn quran al-infitar',
      'quran recitation al-infitar',
      'tajweed al-infitar',
    ],
    alternates: { canonical: '/surah/82/al-infitar' },
    openGraph: {
      title: 'Surah Al-Infitar (الانفطار) — The Cleaving',
      description: 'Read Surah Al-Infitar in English transliteration with Tajweed colour coding. 19 verses, Meccan.',
      url: '/surah/82/al-infitar',
      type: 'article',
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Al-Infitar</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">الانفطار</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Al-Infitar</h2>
        <p className="text-lg text-secondary italic mb-4">The Cleaving</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Al-Infitar with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 1177
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah Al-Infitar</h3>
          <p className="text-secondary leading-relaxed">Describes the Day when the sky is split open and every soul is brought to account.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Al-Infitar is Special</h3>
          <p className="text-secondary leading-relaxed">Contains the verse: "When the sun is wrapped up, when the stars darken."</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">82</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Cleaving</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/1177" className="text-accent hover:underline">
                  Page 1177 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Al-Infitar at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
      ...
      <li class="flex items-center gap-2">
        ...
        <section className="grid grid-cols-2 gap-4">
          <Link href={"/surah/81/" + "at-takwir"} className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">← Previous</span>
            <p className="mt-1 font-semibold text-foreground">Surah At-Takwir</p>
          </Link>
