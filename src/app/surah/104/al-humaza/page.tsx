...
export async function generateStaticParams() {
  return [{ number: '104', slug: 'al-humaza' }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah Al-Humaza (الهمزة) — The Traducer | TajweedTranslit',
    description: 'Read Surah Al-Humaza (The Traducer) — 9 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah Al-Humaza transliteration',
      'Surah 104 tajweed',
      'Al-Humaza meaning',
      'Quran al-humaza transliteration',
      'learn quran al-humaza',
      'quran recitation al-humaza',
      'tajweed al-humaza',
    ],
    alternates: { canonical: '/surah/104/al-humaza' },
    openGraph: {
      title: 'Surah Al-Humaza (الهمزة) — The Traducer',
      description: 'Read Surah Al-Humaza in English transliteration with Tajweed colour coding. 9 verses, Meccan.',
      url: '/surah/104/al-humaza',
      type: 'article',
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Al-Humaza</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">الهمزة</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Al-Humaza</h2>
        <p className="text-lg text-secondary italic mb-4">The Traducer</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Al-Humaza with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 1211
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah Al-Humaza</h3>
          <p className="text-secondary leading-relaxed">Warns against those who find fault with others and accumulate wealth greedily.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Al-Humaza is Special</h3>
          <p className="text-secondary leading-relaxed">Contains the famous verse: "Woe to every slanderer and backbiter."</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">104</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
              <dt className="text-muted text-xs uppercase tracking-wide">Verses</dt>
              <dd className="mt-1 text-lg font-semibold text-foreground">9</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Traducer</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/1211" className="text-accent hover:underline">
                  Page 1211 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Al-Humaza at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
      ...
      <li class="flex items-center gap-2">
        ...
        <section className="grid grid-cols-2 gap-4">
          <Link href={"/surah/103/" + "al-asr"} className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            ...
            <p className="mt-1 font-semibold text-foreground">Surah Al-Asr</p>
          </Link>
          <Link href={"/surah/105/" + "al-fil"} className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">Next →</span>
            <p className="mt-1 font-semibold text-foreground">Surah Al-Fil</p>
          </Link>
        </section>
