...
export async function generateStaticParams() {
  return [{ number: '108', slug: 'al-kawthar' }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah Al-Kawthar (الكوثر) — The Abundance | TajweedTranslit',
    description: 'Read Surah Al-Kawthar (The Abundance) — 3 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah Al-Kawthar transliteration',
      'Surah 108 tajweed',
      'Al-Kawthar meaning',
      'Quran al-kawthar transliteration',
      'learn quran al-kawthar',
      'quran recitation al-kawthar',
      'tajweed al-kawthar',
    ],
    alternates: { canonical: '/surah/108/al-kawthar' },
    openGraph: {
      title: 'Surah Al-Kawthar (الكوثر) — The Abundance',
      description: 'Read Surah Al-Kawthar in English transliteration with Tajweed colour coding. 3 verses, Meccan.',
      url: '/surah/108/al-kawthar',
      type: 'article',
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Al-Kawthar</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">الكوثر</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Al-Kawthar</h2>
        <p className="text-lg text-secondary italic mb-4">The Abundance</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Al-Kawthar with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 1219
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah Al-Kawthar</h3>
          <p className="text-secondary leading-relaxed">Assures the Prophet of abundance — a great river in Paradise — and that his enemies will be cut off.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Al-Kawthar is Special</h3>
          <p className="text-secondary leading-relaxed">Recited in daily Salah by billions of Muslims.</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">108</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Abundance</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/1219" className="text-accent hover:underline">
                  Page 1219 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Al-Kawthar at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
