...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah Abasa (عبس) — He Frowned | TajweedTranslit',
    description: 'Read Surah Abasa (He Frowned) — 42 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah Abasa transliteration',
      'Surah 80 tajweed',
      'Abasa meaning',
      'Quran abasa transliteration',
      'learn quran abasa',
      'quran recitation abasa',
      'tajweed abasa',
    ],
    alternates: { canonical: '/surah/80/abasa' },
    openGraph: {
      title: 'Surah Abasa (عبس) — He Frowned',
      description: 'Read Surah Abasa in English transliteration with Tajweed colour coding. 42 verses, Meccan.',
      url: '/surah/80/abasa',
      type: 'article',
    },
  };
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Abasa</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">عبس</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Abasa</h2>
        <p className="text-lg text-secondary italic mb-4">He Frowned</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Abasa with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 1173
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah Abasa</h3>
          <p className="text-secondary leading-relaxed">Teaches that the Prophet was sent to give warning, not to force belief, and guidance is from Allah alone.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Abasa is Special</h3>
          <p className="text-secondary leading-relaxed">Teaches that one should not look down on others — the blind man was dearer to Allah than the chieftains of Mecca.</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">80</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">He Frowned</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/1173" className="text-accent hover:underline">
                  Page 1173 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Abasa at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
