...
export async function generateStaticParams() {
  return [{ number: '102', slug: 'at-takathur' }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah At-Takathur (التكاثر) — The Rivalry | TajweedTranslit',
    description: 'Read Surah At-Takathur (The Rivalry) — 8 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah At-Takathur transliteration',
      'Surah 102 tajweed',
      'At-Takathur meaning',
      'Quran at-takathur transliteration',
      'learn quran at-takathur',
      'quran recitation at-takathur',
      'tajweed at-takathur',
    ],
    alternates: { canonical: '/surah/102/at-takathur' },
    openGraph: {
      title: 'Surah At-Takathur (التكاثر) — The Rivalry',
      description: 'Read Surah At-Takathur in English transliteration with Tajweed colour coding. 8 verses, Meccan.',
      url: '/surah/102/at-takathur',
      type: 'article',
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah At-Takathur</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">التكاثر</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah At-Takathur</h2>
        <p className="text-lg text-secondary italic mb-4">The Rivalry</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah At-Takathur with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 1207
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah At-Takathur</h3>
          <p className="text-secondary leading-relaxed">Warns against competition for worldly wealth that distracts from the remembrance of Allah.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah At-Takathur is Special</h3>
          <p className="text-secondary leading-relaxed">Contains the verse: "You will most certainly come to know."</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">102</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Rivalry</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/1207" className="text-accent hover:underline">
                  Page 1207 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah At-Takathur at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
