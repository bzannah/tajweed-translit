...
export async function generateStaticParams() {
  return [{ number: '049', slug: 'al-hujurat' }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah Al-Hujurat (الحجرات) — The Rooms | TajweedTranslit',
    description: 'Read Surah Al-Hujurat (The Rooms) — 18 verses, Medinan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah Al-Hujurat transliteration',
      'Surah 49 tajweed',
      'Al-Hujurat meaning',
      'Quran al-hujurat transliteration',
      'learn quran al-hujurat',
      'quran recitation al-hujurat',
      'tajweed al-hujurat',
    ],
    alternates: { canonical: '/surah/49/al-hujurat' },
    openGraph: {
      title: 'Surah Al-Hujurat (الحجرات) — The Rooms',
      description: 'Read Surah Al-Hujurat in English transliteration with Tajweed colour coding. 18 verses, Medinan.',
      url: '/surah/49/al-hujurat',
      type: 'article',
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Al-Hujurat</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">الحجرات</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Al-Hujurat</h2>
        <p className="text-lg text-secondary italic mb-4">The Rooms</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Al-Hujurat with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 1033
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah Al-Hujurat</h3>
          <p className="text-secondary leading-relaxed">Addresses the etiquette of the believers — avoiding suspicion, backbiting, and the equality of all humans.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Al-Hujurat is Special</h3>
          <p className="text-secondary leading-relaxed">Contains the verse: "Indeed, We have created you from male and female and made you peoples and tribes."</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">49</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
              <dt className="text-muted text-xs uppercase tracking-wide">Verses</dt>
              <dd className="mt-1 text-lg font-semibold text-foreground">18</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Rooms</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/1033" className="text-accent hover:underline">
                  Page 1033 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Al-Hujurat at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
      ...
      <li class="flex items-center gap-2">
        ...
        <section className="grid grid-cols-2 gap-4">
          <Link href={"/surah/48/" + "al-fath"} className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">← Previous</span>
            <p className="mt-1 font-semibold text-foreground">Surah Al-Fath</p>
          </Link>
