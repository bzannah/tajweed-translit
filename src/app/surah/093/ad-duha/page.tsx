...
export async function generateStaticParams() {
  return [{ number: "093", slug: "ad-duha" }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Surah Ad-Duha (الضحى) — The Morning Hours | TajweedTranslit",
    description: "Read Surah Ad-Duha (The Morning Hours) — 11 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.",
    keywords: [
      "Surah Ad-Duha transliteration",
      "Surah 93 tajweed",
      "Ad-Duha meaning",
      "Quran ad-duha transliteration",
      "learn quran ad-duha",
      "quran recitation ad-duha",
      "tajweed ad-duha",
    ],
    alternates: { canonical: `/surah/93/ad-duha` },
    openGraph: {
      title: "Surah Ad-Duha (الضحى) — The Morning Hours",
      description: "Read Surah Ad-Duha in English transliteration with Tajweed colour coding. 11 verses, Meccan.",
      url: `/surah/93/ad-duha`,
      type: "article",
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Ad-Duha</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">الضحى</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Ad-Duha</h2>
        <p className="text-lg text-secondary italic mb-4">The Morning Hours</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Ad-Duha with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 1195
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah Ad-Duha</h3>
          <p className="text-secondary leading-relaxed">Revealed when the Prophet was grieved by discontinuation of revelation. It reassures him.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Ad-Duha is Special</h3>
          <p className="text-secondary leading-relaxed">A surah of comfort and reassurance.</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Morning Hours</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/1195" className="text-accent hover:underline">
                  Page 1195 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Ad-Duha at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
        ...
        <section className="grid grid-cols-2 gap-4">
          <Link href="/surah/92/al-layl" className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">← Previous</span>
            <p className="mt-1 font-semibold text-foreground">Surah Al-Layl</p>
          </Link>
          <Link href="/surah/94/ash-sharh" className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">Next →</span>
            <p className="mt-1 font-semibold text-foreground">Surah Ash-Sharh</p>
          </Link>
        </section>
