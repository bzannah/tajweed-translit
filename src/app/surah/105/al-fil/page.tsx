...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah Al-Fil (الفيل) — The Elephant | TajweedTranslit',
    description: 'Read Surah Al-Fil (The Elephant) — 5 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah Al-Fil transliteration',
      'Surah 105 tajweed',
      'Al-Fil meaning',
      'Quran al-fil transliteration',
      'learn quran al-fil',
      'quran recitation al-fil',
      'tajweed al-fil',
    ],
    alternates: { canonical: '/surah/105/al-fil' },
    openGraph: {
      title: 'Surah Al-Fil (الفيل) — The Elephant',
      description: 'Read Surah Al-Fil in English transliteration with Tajweed colour coding. 5 verses, Meccan.',
      url: '/surah/105/al-fil',
      type: 'article',
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Al-Fil</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">الفيل</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Al-Fil</h2>
        <p className="text-lg text-secondary italic mb-4">The Elephant</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Al-Fil with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 1213
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah Al-Fil</h3>
          <p className="text-secondary leading-relaxed">Describes the year of the Elephant when Abraha marched to destroy the Ka'bah.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Al-Fil is Special</h3>
          <p className="text-secondary leading-relaxed">The year of the Elephant (570 CE) marks the birth year of Prophet Muhammad.</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">105</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Elephant</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/1213" className="text-accent hover:underline">
                  Page 1213 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Al-Fil at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
