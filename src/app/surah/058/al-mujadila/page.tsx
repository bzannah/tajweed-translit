...
export async function generateStaticParams() {
  return [{ number: '058', slug: 'al-mujadila' }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah Al-Mujadila (المجادلة) — The Pleading Woman | TajweedTranslit',
    description: 'Read Surah Al-Mujadila (The Pleading Woman) — 22 verses, Medinan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah Al-Mujadila transliteration',
      'Surah 58 tajweed',
      'Al-Mujadila meaning',
      'Quran al-mujadila transliteration',
      'learn quran al-mujadila',
      'quran recitation al-mujadila',
      'tajweed al-mujadila',
    ],
    alternates: { canonical: '/surah/58/al-mujadila' },
    openGraph: {
      title: 'Surah Al-Mujadila (المجادلة) — The Pleading Woman',
      description: 'Read Surah Al-Mujadila in English transliteration with Tajweed colour coding. 22 verses, Medinan.',
      url: '/surah/58/al-mujadila',
      type: 'article',
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Al-Mujadila</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">المجادلة</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Al-Mujadila</h2>
        <p className="text-lg text-secondary italic mb-4">The Pleading Woman</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Al-Mujadila with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 1087
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah Al-Mujadila</h3>
          <p className="text-secondary leading-relaxed">Addresses the case of Khawla bint Thalaba and the ruling on zhihar.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Al-Mujadila is Special</h3>
          <p className="text-secondary leading-relaxed">Contains the verse of purification: "Allah only intends to keep impurity away from you."</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">58</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Pleading Woman</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/1087" className="text-accent hover:underline">
                  Page 1087 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Al-Mujadila at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
      ...
      <li class="flex items-center gap-2">
        ...
        <section className="grid grid-cols-2 gap-4">
          <Link href={"/surah/57/" + "al-hadid"} className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">← Previous</span>
            <p className="mt-1 font-semibold text-foreground">Surah Al-Hadid</p>
          </Link>
