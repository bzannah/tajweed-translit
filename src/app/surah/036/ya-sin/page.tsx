...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah Ya-Sin (يس) — Ya-Sin | TajweedTranslit',
    description: 'Read Surah Ya-Sin (Ya-Sin) — 83 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah Ya-Sin transliteration',
      'Surah 36 tajweed',
      'Ya-Sin meaning',
      'Quran ya-sin transliteration',
      'learn quran ya-sin',
      'quran recitation ya-sin',
      'tajweed ya-sin',
    ],
    alternates: { canonical: '/surah/36/ya-sin' },
    openGraph: {
      title: 'Surah Ya-Sin (يس) — Ya-Sin',
      description: 'Read Surah Ya-Sin in English transliteration with Tajweed colour coding. 83 verses, Meccan.',
      url: '/surah/36/ya-sin',
      type: 'article',
    },
  };
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Ya-Sin</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">يس</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Ya-Sin</h2>
        <p className="text-lg text-secondary italic mb-4">Ya-Sin</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Ya-Sin with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 883
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah Ya-Sin</h3>
          <p className="text-secondary leading-relaxed">Known as the "heart of the Quran." It addresses resurrection and the proof of the Quran.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Ya-Sin is Special</h3>
          <p className="text-secondary leading-relaxed">Reciting Ya-Sin on Friday night is mustahab. It is the Surah of the dead city.</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">36</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
              <dt className="text-muted text-xs uppercase tracking-wide">Verses</dt>
              <dd className="mt-1 text-lg font-semibold text-foreground">83</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">Ya-Sin</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/883" className="text-accent hover:underline">
                  Page 883 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Ya-Sin at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
      ...
      <li class="flex items-center gap-2">
        ...
        <section className="grid grid-cols-2 gap-4">
          <Link href={"/surah/35/" + "fatir"} className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">← Previous</span>
            <p className="mt-1 font-semibold text-foreground">Surah Fatir</p>
          </Link>
          <Link href={"/surah/37/" + "as-saffat"} className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">Next →</span>
            <p className="mt-1 font-semibold text-foreground">Surah As-Saffat</p>
          </Link>
        </section>
