    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        <section>
          ...
          <p className="text-secondary leading-relaxed">Known as the 'Heart of the Quran.' Addresses resurrection and the proof of the Quran.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Ya-Sin is Special</h3>
          <p className="text-secondary leading-relaxed">Reciting Ya-Sin on Friday night is mustahab. The Surah of the dead city.</p>
        </section>
