...
export async function generateStaticParams() {
  return [{ number: '083', slug: 'al-mutaffifin' }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah Al-Mutaffifin (المطففين) — The Defrauding | TajweedTranslit',
    description: 'Read Surah Al-Mutaffifin (The Defrauding) — 36 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah Al-Mutaffifin transliteration',
      'Surah 83 tajweed',
      'Al-Mutaffifin meaning',
      'Quran al-mutaffifin transliteration',
      'learn quran al-mutaffifin',
      'quran recitation al-mutaffifin',
      'tajweed al-mutaffifin',
    ],
    alternates: { canonical: '/surah/83/al-mutaffifin' },
    openGraph: {
      title: 'Surah Al-Mutaffifin (المطففين) — The Defrauding',
      description: 'Read Surah Al-Mutaffifin in English transliteration with Tajweed colour coding. 36 verses, Meccan.',
      url: '/surah/83/al-mutaffifin',
      type: 'article',
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Al-Mutaffifin</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">المطففين</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Al-Mutaffifin</h2>
        <p className="text-lg text-secondary italic mb-4">The Defrauding</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Al-Mutaffifin with Tajweed →
          </Link>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah Al-Mutaffifin</h3>
          <p className="text-secondary leading-relaxed">Warns against those who give short measure in business.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Al-Mutaffifin is Special</h3>
          <p className="text-secondary leading-relaxed">Contains the verse: "Woe to those who give short measure."</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Defrauding</dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Al-Mutaffifin at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
      ...
      <li class="flex items-center gap-2">
        ...
        <section className="grid grid-cols-2 gap-4">
          <Link href={"/surah/82/" + "al-infitar"} className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">← Previous</span>
            <p className="mt-1 font-semibold text-foreground">Surah Al-Infitar</p>
          </Link>
