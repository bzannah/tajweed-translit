...
export async function generateStaticParams() {
  return [{ number: '023', slug: 'al-muminun' }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah Al-Mu'minun (المؤمنون) — The Believers | TajweedTranslit',
    description: 'Read Surah Al-Mu'minun (The Believers) — 118 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah Al-Mu'minun transliteration',
      'Surah 23 tajweed',
      'Al-Mu'minun meaning',
      'Quran al-mu'minun transliteration',
      'learn quran al-mu'minun',
      'quran recitation al-mu'minun',
      'tajweed al-mu'minun',
    ],
    alternates: { canonical: '/surah/23/al-muminun' },
    openGraph: {
      title: 'Surah Al-Mu'minun (المؤمنون) — The Believers',
      description: 'Read Surah Al-Mu'minun in English transliteration with Tajweed colour coding. 118 verses, Meccan.',
      url: '/surah/23/al-muminun',
      type: 'article',
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <header className="px-4 py-12 text-center">
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Al-Mu'minun with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 687
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        <section>
          ...
          <p className="text-secondary leading-relaxed">Describes the qualities of the true believers, the stages of human creation, and the signs of Allah.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Al-Mu'minun is Special</h3>
          <p className="text-secondary leading-relaxed">The surah opens with the description of the believers that is read in daily Salah.</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">23</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
              <dt className="text-muted text-xs uppercase tracking-wide">Verses</dt>
              <dd className="mt-1 text-lg font-semibold text-foreground">118</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Believers</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/687" className="text-accent hover:underline">
                  Page 687 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Al-Mu'minun at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
