...
export async function generateStaticParams() {
  return [{ number: "060", slug: "al-mumtahina" }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Surah Al-Mumtahina (الممتحنة) — The Examined Woman | TajweedTranslit",
    description: "Read Surah Al-Mumtahina (The Examined Woman) — 13 verses, Medinan revelation. English transliteration with expert Tajweed colour coding. Free online reader.",
    keywords: [
      "Surah Al-Mumtahina transliteration",
      "Surah 60 tajweed",
      "Al-Mumtahina meaning",
      "Quran al-mumtahina transliteration",
      "learn quran al-mumtahina",
      "quran recitation al-mumtahina",
      "tajweed al-mumtahina",
    ],
    alternates: { canonical: `/surah/60/al-mumtahina` },
    openGraph: {
      title: "Surah Al-Mumtahina (الممتحنة) — The Examined Woman",
      description: "Read Surah Al-Mumtahina in English transliteration with Tajweed colour coding. 13 verses, Medinan.",
      url: `/surah/60/al-mumtahina`,
      type: "article",
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Al-Mumtahina</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">الممتحنة</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Al-Mumtahina</h2>
        <p className="text-lg text-secondary italic mb-4">The Examined Woman</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Al-Mumtahina with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 1101
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah Al-Mumtahina</h3>
          <p className="text-secondary leading-relaxed">Addresses the rules regarding women who seek refuge with the believers.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Al-Mumtahina is Special</h3>
          <p className="text-secondary leading-relaxed">Establishes that loyalty to Allah takes precedence over all other loyalties.</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Examined Woman</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/1101" className="text-accent hover:underline">
                  Page 1101 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Al-Mumtahina at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
        ...
        <section className="grid grid-cols-2 gap-4">
          <Link href="/surah/59/al-hashr" className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">← Previous</span>
            <p className="mt-1 font-semibold text-foreground">Surah Al-Hashr</p>
          </Link>
          <Link href="/surah/61/as-saff" className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">Next →</span>
            <p className="mt-1 font-semibold text-foreground">Surah As-Saff</p>
          </Link>
        </section>
