...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah Qaf (ق) — Qaf | TajweedTranslit',
    description: 'Read Surah Qaf (Qaf) — 45 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah Qaf transliteration',
      'Surah 50 tajweed',
      'Qaf meaning',
      'Quran qaf transliteration',
      'learn quran qaf',
      'quran recitation qaf',
      'tajweed qaf',
    ],
    alternates: { canonical: '/surah/50/qaf' },
    openGraph: {
      title: 'Surah Qaf (ق) — Qaf',
      description: 'Read Surah Qaf in English transliteration with Tajweed colour coding. 45 verses, Meccan.',
      url: '/surah/50/qaf',
      type: 'article',
    },
  };
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Qaf</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">ق</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Qaf</h2>
        <p className="text-lg text-secondary italic mb-4">Qaf</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Qaf with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 1039
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah Qaf</h3>
          <p className="text-secondary leading-relaxed">Addresses the reality of resurrection and the recording of deeds by angels.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Qaf is Special</h3>
          <p className="text-secondary leading-relaxed">The opening letters of this surah are among the Ha Mim letters.</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">Qaf</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/1039" className="text-accent hover:underline">
                  Page 1039 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Qaf at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
