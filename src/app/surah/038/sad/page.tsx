...
export async function generateMetadata({ params }: Props): Promise<Metadata {
  ...
  return {
    title: "Surah Sad (ص) — Sad | TajweedTranslit",
    description: "Read Surah Sad (Sad) — 88 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.",
    keywords: [
      "Surah Sad transliteration",
      "Surah 38 tajweed",
      "Sad meaning",
      "Quran sad transliteration",
      "learn quran sad",
      "quran recitation sad",
      "tajweed sad",
    ],
    alternates: { canonical: `/surah/38/sad` },
    openGraph: {
      title: "Surah Sad (ص) — Sad",
      description: "Read Surah Sad in English transliteration with Tajweed colour coding. 88 verses, Meccan.",
      url: `/surah/38/sad`,
      type: "article",
    },
  };
    ...
    <div className="min-h-screen bg-background text-foreground"
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb"
        <ol className="flex items-center gap-2 text-muted"
          ...
          <li/</li
          <li className="text-foreground" aria-current="page"Surah Sad</li
        </ol
      </nav
      ...
      <header className="px-4 py-12 text-center"
        ...
        <h1 className="font-brand text-4xl text-accent mb-2"ص</h1
        <h2 className="font-brand text-2xl text-foreground mb-1"Surah Sad</h2
        <p className="text-lg text-secondary italic mb-4"Sad</p
        ...
        <div className="mt-8"
          <Link
            ...
            Read Surah Sad with Tajweed →
          </Link
          <p className="mt-2 text-xs text-muted"
            Colour-coded transliteration · Page 909
          </p
        </div
      </header
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12"
        ...
        {/* About */}
        <section
          <h3 className="font-brand text-xl text-accent mb-4"About Surah Sad</h3
          <p className="text-secondary leading-relaxed"Addresses the stories of Dawud and Sulayman and the proofs of prophethood.</p
        </section

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6"
          <h3 className="font-brand text-lg text-accent mb-3"Why Surah Sad is Special</h3
          <p className="text-secondary leading-relaxed"Contains the story of the hoopoe bird and Sulayman&#39;s kingdom.</p
        </section
        ...
        <section
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm"
            <div className="rounded-lg border border-border bg-surface p-4"
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground"38</dd
            </div
            <div className="rounded-lg border border-border bg-surface p-4"
            ...
            <div className="rounded-lg border border-border bg-surface p-4"
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic"Sad</dd
            </div
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2"
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground"
                <Link href="/page/909" className="text-accent hover:underline"
                  Page 909 →
                </Link
              </dd
            </div
        ...
        <section
          ...
          <p className="text-sm text-secondary mb-4"
            When reading Surah Sad at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p
        ...
        <section className="grid grid-cols-2 gap-4"
          ...
          <Link href="/surah/39/az-zumar" className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors"
            <span className="text-xs text-muted"Next →</span
            <p className="mt-1 font-semibold text-foreground"Surah Az-Zumar</p
          </Link
        </section
