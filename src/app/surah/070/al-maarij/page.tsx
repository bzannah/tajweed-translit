...
export async function generateStaticParams() {
  return [{ number: '070', slug: 'al-maarij' }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah Al-Ma'arij (المعارج) — The Ascending Stairways | TajweedTranslit',
    description: 'Read Surah Al-Ma'arij (The Ascending Stairways) — 44 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah Al-Ma'arij transliteration',
      'Surah 70 tajweed',
      'Al-Ma'arij meaning',
      'Quran al-ma'arij transliteration',
      'learn quran al-ma'arij',
      'quran recitation al-ma'arij',
      'tajweed al-ma'arij',
    ],
    alternates: { canonical: '/surah/70/al-maarij' },
    openGraph: {
      title: 'Surah Al-Ma'arij (المعارج) — The Ascending Stairways',
      description: 'Read Surah Al-Ma'arij in English transliteration with Tajweed colour coding. 44 verses, Meccan.',
      url: '/surah/70/al-maarij',
      type: 'article',
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <header className="px-4 py-12 text-center">
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Al-Ma'arij with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 1139
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">70</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Ascending Stairways</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/1139" className="text-accent hover:underline">
                  Page 1139 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Al-Ma'arij at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
