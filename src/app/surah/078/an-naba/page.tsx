...
export async function generateStaticParams() {
  return [{ number: "078", slug: "an-naba" }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata {
  ...
  return {
    title: "Surah An-Naba (النبأ) — The Tidings | TajweedTranslit",
    description: "Read Surah An-Naba (The Tidings) — 40 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.",
    keywords: [
      "Surah An-Naba transliteration",
      "Surah 78 tajweed",
      "An-Naba meaning",
      "Quran an-naba transliteration",
      "learn quran an-naba",
      "quran recitation an-naba",
      "tajweed an-naba",
    ],
    alternates: { canonical: `/surah/78/an-naba` },
    openGraph: {
      title: "Surah An-Naba (النبأ) — The Tidings",
      description: "Read Surah An-Naba in English transliteration with Tajweed colour coding. 40 verses, Meccan.",
      url: `/surah/78/an-naba`,
      type: "article",
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground"
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb"
        <ol className="flex items-center gap-2 text-muted"
          ...
          <li/</li
          <li className="text-foreground" aria-current="page"Surah An-Naba</li
        </ol
      </nav
      ...
      <header className="px-4 py-12 text-center"
        ...
        <h1 className="font-brand text-4xl text-accent mb-2"النبأ</h1
        <h2 className="font-brand text-2xl text-foreground mb-1"Surah An-Naba</h2
        <p className="text-lg text-secondary italic mb-4"The Tidings</p
        ...
        <div className="mt-8"
          <Link
            ...
            Read Surah An-Naba with Tajweed →
          </Link
          <p className="mt-2 text-xs text-muted"
            Colour-coded transliteration · Page 1167
          </p
        </div
      </header
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12"
        ...
        {/* About */}
        <section
          <h3 className="font-brand text-xl text-accent mb-4"About Surah An-Naba</h3
          <p className="text-secondary leading-relaxed"Introduces the Day of Judgment as the great news that humanity disputes about.</p
        </section

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6"
          <h3 className="font-brand text-lg text-accent mb-3"Why Surah An-Naba is Special</h3
          <p className="text-secondary leading-relaxed"The first of the &#39;Mufassalat&#39; surahs.</p
        </section
        ...
        <section
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm"
            <div className="rounded-lg border border-border bg-surface p-4"
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground"78</dd
            </div
            <div className="rounded-lg border border-border bg-surface p-4"
            ...
            <div className="rounded-lg border border-border bg-surface p-4"
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic"The Tidings</dd
            </div
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2"
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground"
                <Link href="/page/1167" className="text-accent hover:underline"
                  Page 1167 →
                </Link
              </dd
            </div
        ...
        <section
          ...
          <p className="text-sm text-secondary mb-4"
            When reading Surah An-Naba at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p
        ...
        <section className="grid grid-cols-2 gap-4"
          ...
          <Link href="/surah/79/an-naziat" className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors"
            <span className="text-xs text-muted"Next →</span
            <p className="mt-1 font-semibold text-foreground"Surah An-Nazi&#39;at</p
          </Link
        </section
