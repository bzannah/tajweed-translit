...
export async function generateMetadata({ params }: Props): Promise<Metadata {
  ...
  return {
    title: "Surah Ghafir (غافر) — The Forgiver | TajweedTranslit",
    description: "Read Surah Ghafir (The Forgiver) — 85 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.",
    keywords: [
      "Surah Ghafir transliteration",
      "Surah 40 tajweed",
      "Ghafir meaning",
      "Quran ghafir transliteration",
      "learn quran ghafir",
      "quran recitation ghafir",
      "tajweed ghafir",
    ],
    alternates: { canonical: `/surah/40/ghafir` },
    openGraph: {
      title: "Surah Ghafir (غافر) — The Forgiver",
      description: "Read Surah Ghafir in English transliteration with Tajweed colour coding. 85 verses, Meccan.",
      url: `/surah/40/ghafir`,
      type: "article",
    },
  };
    ...
    <div className="min-h-screen bg-background text-foreground"
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb"
        <ol className="flex items-center gap-2 text-muted"
          ...
          <li/</li
          <li className="text-foreground" aria-current="page"Surah Ghafir</li
        </ol
      </nav
      ...
      <header className="px-4 py-12 text-center"
        ...
        <h1 className="font-brand text-4xl text-accent mb-2"غافر</h1
        <h2 className="font-brand text-2xl text-foreground mb-1"Surah Ghafir</h2
        <p className="text-lg text-secondary italic mb-4"The Forgiver</p
        ...
        <div className="mt-8"
          <Link
            ...
            Read Surah Ghafir with Tajweed →
          </Link
          <p className="mt-2 text-xs text-muted"
            Colour-coded transliteration · Page 937
          </p
        </div
      </header
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12"
        ...
        <section
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm"
            ...
            <div className="rounded-lg border border-border bg-surface p-4"
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic"The Forgiver</dd
            </div
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2"
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground"
                <Link href="/page/937" className="text-accent hover:underline"
                  Page 937 →
                </Link
              </dd
            </div
        ...
        <section
          ...
          <p className="text-sm text-secondary mb-4"
            When reading Surah Ghafir at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p
