...
export async function generateStaticParams() {
  return [{ number: "033", slug: "al-ahzab" }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Surah Al-Ahzab (الأحزاب) — The Confederates | TajweedTranslit",
    description: "Read Surah Al-Ahzab (The Confederates) — 73 verses, Medinan revelation. English transliteration with expert Tajweed colour coding. Free online reader.",
    keywords: [
      "Surah Al-Ahzab transliteration",
      "Surah 33 tajweed",
      "Al-Ahzab meaning",
      "Quran al-ahzab transliteration",
      "learn quran al-ahzab",
      "quran recitation al-ahzab",
      "tajweed al-ahzab",
    ],
    alternates: { canonical: `/surah/33/al-ahzab` },
    openGraph: {
      title: "Surah Al-Ahzab (الأحزاب) — The Confederates",
      description: "Read Surah Al-Ahzab in English transliteration with Tajweed colour coding. 73 verses, Medinan.",
      url: `/surah/33/al-ahzab`,
      type: "article",
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Al-Ahzab</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">الأحزاب</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Al-Ahzab</h2>
        <p className="text-lg text-secondary italic mb-4">The Confederates</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Al-Ahzab with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 839
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah Al-Ahzab</h3>
          <p className="text-secondary leading-relaxed">Addresses the Battle of the Trench, the incident of the slander, and the family of the Prophet.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Al-Ahzab is Special</h3>
          <p className="text-secondary leading-relaxed">Contains the verse of adoption and its nullification.</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">33</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
              <dt className="text-muted text-xs uppercase tracking-wide">Verses</dt>
              <dd className="mt-1 text-lg font-semibold text-foreground">73</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Confederates</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/839" className="text-accent hover:underline">
                  Page 839 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Al-Ahzab at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
        ...
        <section className="grid grid-cols-2 gap-4">
          <Link href="/surah/32/as-sajda" className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">← Previous</span>
            <p className="mt-1 font-semibold text-foreground">Surah As-Sajda</p>
          </Link>
          <Link href="/surah/34/saba" className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">Next →</span>
            <p className="mt-1 font-semibold text-foreground">Surah Saba</p>
          </Link>
        </section>
