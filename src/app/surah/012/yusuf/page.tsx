...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah Yusuf (يوسف) — Joseph | TajweedTranslit',
    description: 'Read Surah Yusuf (Joseph) — 111 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah Yusuf transliteration',
      'Surah 12 tajweed',
      'Yusuf meaning',
      'Quran yusuf transliteration',
      'learn quran yusuf',
      'quran recitation yusuf',
      'tajweed yusuf',
    ],
    alternates: { canonical: '/surah/12/yusuf' },
    openGraph: {
      title: 'Surah Yusuf (يوسف) — Joseph',
      description: 'Read Surah Yusuf in English transliteration with Tajweed colour coding. 111 verses, Meccan.',
      url: '/surah/12/yusuf',
      type: 'article',
    },
  };
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Yusuf</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">يوسف</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Yusuf</h2>
        <p className="text-lg text-secondary italic mb-4">Joseph</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Yusuf with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 473
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah Yusuf</h3>
          <p className="text-secondary leading-relaxed">The complete narrative of the prophet Yusuf from childhood to becoming Egypt's minister. Considered the most beautiful story in the Quran.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Yusuf is Special</h3>
          <p className="text-secondary leading-relaxed">Contains the most complete narrative of any prophet in the Quran.</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">Joseph</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/473" className="text-accent hover:underline">
                  Page 473 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Yusuf at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
