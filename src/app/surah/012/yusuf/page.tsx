    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        <section>
          ...
          <p className="text-secondary leading-relaxed">The complete narrative of the prophet Yusuf from childhood to becoming Egypt's minister. The most beautiful story in the Quran.</p>
        </section>
