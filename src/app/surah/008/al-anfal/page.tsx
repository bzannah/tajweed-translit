...
export async function generateStaticParams() {
  return [{ number: '008', slug: 'al-anfal' }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah Al-Anfal (الأنفال) — The Spoils of War | TajweedTranslit',
    description: 'Read Surah Al-Anfal (The Spoils of War) — 75 verses, Medinan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah Al-Anfal transliteration',
      'Surah 8 tajweed',
      'Al-Anfal meaning',
      'Quran al-anfal transliteration',
      'learn quran al-anfal',
      'quran recitation al-anfal',
      'tajweed al-anfal',
    ],
    alternates: { canonical: '/surah/8/al-anfal' },
    openGraph: {
      title: 'Surah Al-Anfal (الأنفال) — The Spoils of War',
      description: 'Read Surah Al-Anfal in English transliteration with Tajweed colour coding. 75 verses, Medinan.',
      url: '/surah/8/al-anfal',
      type: 'article',
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Al-Anfal</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">الأنفال</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Al-Anfal</h2>
        <p className="text-lg text-secondary italic mb-4">The Spoils of War</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Al-Anfal with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 357
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah Al-Anfal</h3>
          <p className="text-secondary leading-relaxed">Revealed after the Battle of Badr (624 CE), Al-Anfal addresses the distribution of war spoils and the qualities of true believers.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Al-Anfal is Special</h3>
          <p className="text-secondary leading-relaxed">First surah revealed concerning a specific military engagement — the Battle of Badr.</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Spoils of War</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/357" className="text-accent hover:underline">
                  Page 357 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Al-Anfal at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
      ...
      <li class="flex items-center gap-2">
        ...
        <section className="grid grid-cols-2 gap-4">
          ...
          <Link href={"/surah/9/" + "at-tawba"} className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">Next →</span>
            <p className="mt-1 font-semibold text-foreground">Surah At-Tawba</p>
          </Link>
        </section>
