...
export async function generateStaticParams() {
  return [{ number: "004", slug: "an-nisa" }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Surah An-Nisa (النساء) — The Women | TajweedTranslit",
    description: "Read Surah An-Nisa (The Women) — 176 verses, Medinan revelation. English transliteration with expert Tajweed colour coding. Free online reader.",
    keywords: [
      "Surah An-Nisa transliteration",
      "Surah 4 tajweed",
      "An-Nisa meaning",
      "Quran an-nisa transliteration",
      "learn quran an-nisa",
      "quran recitation an-nisa",
      "tajweed an-nisa",
    ],
    alternates: { canonical: `/surah/4/an-nisa` },
    openGraph: {
      title: "Surah An-Nisa (النساء) — The Women",
      description: "Read Surah An-Nisa in English transliteration with Tajweed colour coding. 176 verses, Medinan.",
      url: `/surah/4/an-nisa`,
      type: "article",
    },
  };
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah An-Nisa</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">النساء</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah An-Nisa</h2>
        <p className="text-lg text-secondary italic mb-4">The Women</p>
        <div className="flex flex-wrap justify-center items-center gap-4 text-sm text-muted">
          <span>🏙️ Medinan Revelation</span>
          <span>•</span>
          <span>176 verses</span>
          <span>•</span>
          <span>Page 157</span>
        </div>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah An-Nisa with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 157
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah An-Nisa</h3>
          <p className="text-secondary leading-relaxed">The Surah of Women addresses family law, inheritance, marriage, and the rights of women in Islam.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah An-Nisa is Special</h3>
          <p className="text-secondary leading-relaxed">Covers 23% of Islamic jurisprudence including inheritance rules.</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">176</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Women</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/157" className="text-accent hover:underline">
                  Page 157 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah An-Nisa at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
