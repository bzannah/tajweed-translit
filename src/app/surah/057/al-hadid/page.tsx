...
export async function generateStaticParams() {
  return [{ number: '057', slug: 'al-hadid' }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah Al-Hadid (الحديد) — The Iron | TajweedTranslit',
    description: 'Read Surah Al-Hadid (The Iron) — 29 verses, Medinan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah Al-Hadid transliteration',
      'Surah 57 tajweed',
      'Al-Hadid meaning',
      'Quran al-hadid transliteration',
      'learn quran al-hadid',
      'quran recitation al-hadid',
      'tajweed al-hadid',
    ],
    alternates: { canonical: '/surah/57/al-hadid' },
    openGraph: {
      title: 'Surah Al-Hadid (الحديد) — The Iron',
      description: 'Read Surah Al-Hadid in English transliteration with Tajweed colour coding. 29 verses, Medinan.',
      url: '/surah/57/al-hadid',
      type: 'article',
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Al-Hadid</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">الحديد</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Al-Hadid</h2>
        <p className="text-lg text-secondary italic mb-4">The Iron</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Al-Hadid with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 1077
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah Al-Hadid</h3>
          <p className="text-secondary leading-relaxed">Describes iron as benefit to humanity and calls believers to struggle in the way of Allah.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Al-Hadid is Special</h3>
          <p className="text-secondary leading-relaxed">Contains the verse: "And strive for Allah with the striving due to Him."</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">57</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Iron</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/1077" className="text-accent hover:underline">
                  Page 1077 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Al-Hadid at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
