...
export async function generateStaticParams() {
  return [{ number: '100', slug: 'al-adiyat' }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah Al-Adiyat (العاديات) — The Chargers | TajweedTranslit',
    description: 'Read Surah Al-Adiyat (The Chargers) — 11 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah Al-Adiyat transliteration',
      'Surah 100 tajweed',
      'Al-Adiyat meaning',
      'Quran al-adiyat transliteration',
      'learn quran al-adiyat',
      'quran recitation al-adiyat',
      'tajweed al-adiyat',
    ],
    alternates: { canonical: '/surah/100/al-adiyat' },
    openGraph: {
      title: 'Surah Al-Adiyat (العاديات) — The Chargers',
      description: 'Read Surah Al-Adiyat in English transliteration with Tajweed colour coding. 11 verses, Meccan.',
      url: '/surah/100/al-adiyat',
      type: 'article',
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Al-Adiyat</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">العاديات</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Al-Adiyat</h2>
        <p className="text-lg text-secondary italic mb-4">The Chargers</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Al-Adiyat with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 1203
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah Al-Adiyat</h3>
          <p className="text-secondary leading-relaxed">Swears by the swift horses that charge into battle.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Al-Adiyat is Special</h3>
          <p className="text-secondary leading-relaxed">Contains the verse: "Indeed, mankind is ungrateful to his Lord."</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">100</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Chargers</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/1203" className="text-accent hover:underline">
                  Page 1203 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Al-Adiyat at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
