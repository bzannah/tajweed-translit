...
export async function generateStaticParams() {
  return [{ number: '098', slug: 'al-bayyina' }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah Al-Bayyina (البينة) — The Clear Proof | TajweedTranslit',
    description: 'Read Surah Al-Bayyina (The Clear Proof) — 8 verses, Medinan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah Al-Bayyina transliteration',
      'Surah 98 tajweed',
      'Al-Bayyina meaning',
      'Quran al-bayyina transliteration',
      'learn quran al-bayyina',
      'quran recitation al-bayyina',
      'tajweed al-bayyina',
    ],
    alternates: { canonical: '/surah/98/al-bayyina' },
    openGraph: {
      title: 'Surah Al-Bayyina (البينة) — The Clear Proof',
      description: 'Read Surah Al-Bayyina in English transliteration with Tajweed colour coding. 8 verses, Medinan.',
      url: '/surah/98/al-bayyina',
      type: 'article',
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Al-Bayyina</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">البينة</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Al-Bayyina</h2>
        <p className="text-lg text-secondary italic mb-4">The Clear Proof</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Al-Bayyina with Tajweed →
          </Link>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah Al-Bayyina</h3>
          <p className="text-secondary leading-relaxed">Declares that the Quran is the clear proof from Allah sent after previous scriptures.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Al-Bayyina is Special</h3>
          <p className="text-secondary leading-relaxed">Contains the verse: "Not equal are the companions of the Fire and the companions of Paradise."</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">98</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
              <dt className="text-muted text-xs uppercase tracking-wide">Verses</dt>
              <dd className="mt-1 text-lg font-semibold text-foreground">8</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Clear Proof</dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Al-Bayyina at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
      ...
      <li class="flex items-center gap-2">
        ...
        <section className="grid grid-cols-2 gap-4">
          <Link href={"/surah/97/" + "al-qadr"} className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">← Previous</span>
            <p className="mt-1 font-semibold text-foreground">Surah Al-Qadr</p>
          </Link>
          <Link href={"/surah/99/" + "az-zalzala"} className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">Next →</span>
            <p className="mt-1 font-semibold text-foreground">Surah Az-Zalzala</p>
          </Link>
        </section>
