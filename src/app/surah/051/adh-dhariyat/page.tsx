...
export async function generateStaticParams() {
  return [{ number: '051', slug: 'adh-dhariyat' }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah Adh-Dhariyat (الذاريات) — The Scattering Winds | TajweedTranslit',
    description: 'Read Surah Adh-Dhariyat (The Scattering Winds) — 60 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah Adh-Dhariyat transliteration',
      'Surah 51 tajweed',
      'Adh-Dhariyat meaning',
      'Quran adh-dhariyat transliteration',
      'learn quran adh-dhariyat',
      'quran recitation adh-dhariyat',
      'tajweed adh-dhariyat',
    ],
    alternates: { canonical: '/surah/51/adh-dhariyat' },
    openGraph: {
      title: 'Surah Adh-Dhariyat (الذاريات) — The Scattering Winds',
      description: 'Read Surah Adh-Dhariyat in English transliteration with Tajweed colour coding. 60 verses, Meccan.',
      url: '/surah/51/adh-dhariyat',
      type: 'article',
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Adh-Dhariyat</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">الذاريات</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Adh-Dhariyat</h2>
        <p className="text-lg text-secondary italic mb-4">The Scattering Winds</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Adh-Dhariyat with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 1043
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah Adh-Dhariyat</h3>
          <p className="text-secondary leading-relaxed">Swears by the winds that scatter, clouds that carry rain, and ships that sail.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Adh-Dhariyat is Special</h3>
          <p className="text-secondary leading-relaxed">Contains the famous verse: "And upon Allah is the direction of the affair."</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">51</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
              <dt className="text-muted text-xs uppercase tracking-wide">Verses</dt>
              <dd className="mt-1 text-lg font-semibold text-foreground">60</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Scattering Winds</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/1043" className="text-accent hover:underline">
                  Page 1043 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Adh-Dhariyat at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
      ...
      <li class="flex items-center gap-2">
        ...
        <section className="grid grid-cols-2 gap-4">
          <Link href={"/surah/50/" + "qaf"} className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">← Previous</span>
            <p className="mt-1 font-semibold text-foreground">Surah Qaf</p>
          </Link>
          <Link href={"/surah/52/" + "at-tur"} className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">Next →</span>
            <p className="mt-1 font-semibold text-foreground">Surah At-Tur</p>
          </Link>
        </section>
