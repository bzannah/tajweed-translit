...
export async function generateStaticParams() {
  return [{ number: '065', slug: 'at-talaq' }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah At-Talaq (الطلاق) — Divorce | TajweedTranslit',
    description: 'Read Surah At-Talaq (Divorce) — 12 verses, Medinan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah At-Talaq transliteration',
      'Surah 65 tajweed',
      'At-Talaq meaning',
      'Quran at-talaq transliteration',
      'learn quran at-talaq',
      'quran recitation at-talaq',
      'tajweed at-talaq',
    ],
    alternates: { canonical: '/surah/65/at-talaq' },
    openGraph: {
      title: 'Surah At-Talaq (الطلاق) — Divorce',
      description: 'Read Surah At-Talaq in English transliteration with Tajweed colour coding. 12 verses, Medinan.',
      url: '/surah/65/at-talaq',
      type: 'article',
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah At-Talaq</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">الطلاق</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah At-Talaq</h2>
        <p className="text-lg text-secondary italic mb-4">Divorce</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah At-Talaq with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 1119
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah At-Talaq</h3>
          <p className="text-secondary leading-relaxed">Provides comprehensive rulings on divorce and the waiting period.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah At-Talaq is Special</h3>
          <p className="text-secondary leading-relaxed">Contains the verse about how Allah intends ease for you, not hardship.</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">65</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">Divorce</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/1119" className="text-accent hover:underline">
                  Page 1119 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah At-Talaq at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
