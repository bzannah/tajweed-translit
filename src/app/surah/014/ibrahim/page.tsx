...
export async function generateStaticParams() {
  return [{ number: '014', slug: 'ibrahim' }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah Ibrahim (إبراهيم) — Abraham | TajweedTranslit',
    description: 'Read Surah Ibrahim (Abraham) — 52 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah Ibrahim transliteration',
      'Surah 14 tajweed',
      'Ibrahim meaning',
      'Quran ibrahim transliteration',
      'learn quran ibrahim',
      'quran recitation ibrahim',
      'tajweed ibrahim',
    ],
    alternates: { canonical: '/surah/14/ibrahim' },
    openGraph: {
      title: 'Surah Ibrahim (إبراهيم) — Abraham',
      description: 'Read Surah Ibrahim in English transliteration with Tajweed colour coding. 52 verses, Meccan.',
      url: '/surah/14/ibrahim',
      type: 'article',
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Ibrahim</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">إبراهيم</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Ibrahim</h2>
        <p className="text-lg text-secondary italic mb-4">Abraham</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Ibrahim with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 513
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        <section className="rounded-xl border border-border bg-surface p-6">
          ...
          <p className="text-secondary leading-relaxed">Contains Ibrahim's prayer for Mecca — a supplication still relevant today.</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">Abraham</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/513" className="text-accent hover:underline">
                  Page 513 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Ibrahim at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
