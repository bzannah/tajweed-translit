...
export async function generateStaticParams() {
  return [{ number: "021", slug: "al-anbiya" }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Surah Al-Anbiya (الأنبياء) — The Prophets | TajweedTranslit",
    description: "Read Surah Al-Anbiya (The Prophets) — 112 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.",
    keywords: [
      "Surah Al-Anbiya transliteration",
      "Surah 21 tajweed",
      "Al-Anbiya meaning",
      "Quran al-anbiya transliteration",
      "learn quran al-anbiya",
      "quran recitation al-anbiya",
      "tajweed al-anbiya",
    ],
    alternates: { canonical: `/surah/21/al-anbiya` },
    openGraph: {
      title: "Surah Al-Anbiya (الأنبياء) — The Prophets",
      description: "Read Surah Al-Anbiya in English transliteration with Tajweed colour coding. 112 verses, Meccan.",
      url: `/surah/21/al-anbiya`,
      type: "article",
    },
  };
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Al-Anbiya</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">الأنبياء</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Al-Anbiya</h2>
        <p className="text-lg text-secondary italic mb-4">The Prophets</p>
        <div className="flex flex-wrap justify-center items-center gap-4 text-sm text-muted">
          <span>🏔️ Meccan Revelation</span>
          <span>•</span>
          <span>112 verses</span>
          <span>•</span>
          <span>Page 647</span>
        </div>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Al-Anbiya with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 647
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah Al-Anbiya</h3>
          <p className="text-secondary leading-relaxed">Presents stories of numerous prophets united in one message: worship Allah alone.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Al-Anbiya is Special</h3>
          <p className="text-secondary leading-relaxed">Reciting this Surah is mustahab for those seeking children.</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">112</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Prophets</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/647" className="text-accent hover:underline">
                  Page 647 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Al-Anbiya at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
        ...
        <section className="grid grid-cols-2 gap-4">
          <Link href="/surah/20/taha" className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">← Previous</span>
            <p className="mt-1 font-semibold text-foreground">Surah Taha</p>
          </Link>
          <Link href="/surah/22/al-hajj" className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">Next →</span>
            <p className="mt-1 font-semibold text-foreground">Surah Al-Hajj</p>
          </Link>
        </section>
