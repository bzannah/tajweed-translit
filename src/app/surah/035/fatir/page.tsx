...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Surah Fatir (فاطر) — The Originator | TajweedTranslit',
    description: 'Read Surah Fatir (The Originator) — 45 verses, Meccan revelation. English transliteration with expert Tajweed colour coding. Free online reader.',
    keywords: [
      'Surah Fatir transliteration',
      'Surah 35 tajweed',
      'Fatir meaning',
      'Quran fatir transliteration',
      'learn quran fatir',
      'quran recitation fatir',
      'tajweed fatir',
    ],
    alternates: { canonical: '/surah/35/fatir' },
    openGraph: {
      title: 'Surah Fatir (فاطر) — The Originator',
      description: 'Read Surah Fatir in English transliteration with Tajweed colour coding. 45 verses, Meccan.',
      url: '/surah/35/fatir',
      type: 'article',
    },
  };
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border px-4 py-3 text-sm" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-muted">
          ...
          <li>/</li>
          <li className="text-foreground" aria-current="page">Surah Fatir</li>
        </ol>
      </nav>
      ...
      <header className="px-4 py-12 text-center">
        ...
        <h1 className="font-brand text-4xl text-accent mb-2">فاطر</h1>
        <h2 className="font-brand text-2xl text-foreground mb-1">Surah Fatir</h2>
        <p className="text-lg text-secondary italic mb-4">The Originator</p>
        ...
        <div className="mt-8">
          ...
          >
            Read Surah Fatir with Tajweed →
          </Link>
          <p className="mt-2 text-xs text-muted">
            Colour-coded transliteration · Page 871
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 space-y-12">
        ...
        {/* About */}
        <section>
          <h3 className="font-brand text-xl text-accent mb-4">About Surah Fatir</h3>
          <p className="text-secondary leading-relaxed">Emphasizes the signs of Allah in creation, calling humanity to reflect and believe.</p>
        </section>

        {/* Significance */}
        <section className="rounded-xl border border-border bg-surface p-6">
          <h3 className="font-brand text-lg text-accent mb-3">Why Surah Fatir is Special</h3>
          <p className="text-secondary leading-relaxed">Contains the verse: "Whoever does righteousness — it is for his soul."</p>
        </section>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground italic">The Originator</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4 col-span-2">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">
                <Link href="/page/871" className="text-accent hover:underline">
                  Page 871 →
                </Link>
              </dd>
            </div>
        ...
        <section>
          ...
          <p className="text-sm text-secondary mb-4">
            When reading Surah Fatir at TajweedTranslit.com, these Tajweed rules are colour-coded:
          </p>
