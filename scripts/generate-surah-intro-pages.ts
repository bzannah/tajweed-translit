 ...
 * Generates /surah/[number]/[slug] pages for all 114 Surahs.
 * Each page is a rich SEO-optimized introduction with Surah metadata,
 * Tajweed rules overview, and a CTA to the reading page.
 *
 * Route: src/app/surah/[number]/[slug]/page.tsx
 * Run:   pnpm generate:surah-pages
 */

import { writeFileSync, mkdirSync } from 'fs';
import { join } from 'path';

const OUT_DIR = join(process.cwd(), 'src', 'app', 'surah');
...
const SURAH_DATA: Array<{
  ...
  revelation_type: 'Meccan' | 'Medinan'; verses: number; starting_page: number;
  ...
  { number: 2,   name: 'Al-Baqara',    name_arabic: 'البقرة',     meaning: 'The Cow',                revelation_type: 'Medinan', verses: 286,  starting_page: 7,  description: 'The longest Surah of the Quran, Al-Baqara covers foundational rulings, stories of previous prophets, and the qualities of the righteous. It was revealed over 8–9 years.', significance: 'Contains Ayat al-Kursi (the Throne Verse) — the greatest verse in the Quran.' },
  ...
  { number: 7,   name: 'Al-A\'raf',   name_arabic: 'الأعراف',    meaning: 'The Heights',            revelation_type: 'Meccan',  verses: 206,  starting_page: 305,description: 'Al-A\'raf bridges the stories of previous prophets and the final warnings to Mecca. It details the barrier between Paradise and Hell.', significance: 'Contains the detailed account of the conversation between the people of Paradise and Hell.' },
  { number: 8,   name: 'Al-Anfal',    name_arabic: 'الأنفال',    meaning: 'The Spoils of War',      revelation_type: 'Medinan', verses: 75,   starting_page: 357,description: 'Revealed after the Battle of Badr (624 CE), Al-Anfal addresses the distribution of war spoils and the qualities of true believers.', significance: 'First surah revealed concerning a specific military engagement — the Battle of Badr.' },
  { number: 9,   name: 'At-Tawba',    name_arabic: 'التوبة',    meaning: 'The Repentance',          revelation_type: 'Medinan', verses: 129,  starting_page: 377,description: 'At-Tawba is the declaration of immunity from polytheism, announcing the completion of the covenant with polytheists. Also called Al-Bar\'a.', significance: 'Announces the liberation of Mecca and the end of the pre-Islamic era of polytheism.' },
  { number: 10,  name: 'Yunus',       name_arabic: 'يونس',       meaning: 'Jonah',                  revelation_type: 'Meccan',  verses: 109,  starting_page: 419,description: 'Contains the story of the prophet Yunus — how he was swallowed by a great fish and how his people later repented.', significance: 'Contains the famous verse: "Indeed, Allah does not forgive associating partners with Him."' },
  ...
  { number: 12,  name: 'Yusuf',        name_arabic: 'يوسف',       meaning: 'Joseph',                 revelation_type: 'Meccan',  verses: 111,  starting_page: 473,description: 'The complete narrative of the prophet Yusuf from childhood to becoming Egypt\'s minister. Considered the most beautiful story in the Quran.', significance: 'Contains the most complete narrative of any prophet in the Quran.' },
  { number: 13,  name: 'Ar-Ra\'d',     name_arabic: 'الرعد',      meaning: 'The Thunder',            revelation_type: 'Medinan', verses: 43,   starting_page: 501,description: 'Contains profound arguments for faith through the signs in nature, the parable of the barren land, and the concept of life after death.', significance: 'Contains the verse establishing that Faith increases and decreases.' },
  { number: 14,  name: 'Ibrahim',      name_arabic: 'إبراهيم',    meaning: 'Abraham',                revelation_type: 'Meccan',  verses: 52,   starting_page: 513,description: 'Named after the prophet Ibrahim, this Surah recounts his mission and the building of the Ka\'bah.', significance: 'Contains Ibrahim\'s prayer for Mecca — a supplication still relevant today.' },
  ...
  { number: 16,  name: 'An-Nahl',      name_arabic: 'النحل',      meaning: 'The Bee',               revelation_type: 'Meccan',  verses: 128,  starting_page: 537,description: 'Contains the evidences of Allah\'s creation including the bee, the seasons, the water cycle, and human civilization.', significance: 'Contains the verse: "Allah does not forbid you from being good to those who have not fought you."' },
  { number: 17,  name: 'Al-Isra',      name_arabic: 'الإسراء',    meaning: 'The Night Journey',     revelation_type: 'Meccan',  verses: 111,  starting_page: 567,description: 'Records the Night Journey (Isra) from Mecca to Jerusalem and the Ascension (Miraj).', significance: 'Contains the famous command: "No soul shall die except by Allah\'s permission."' },
  ...
  { number: 20,  name: 'Taha',         name_arabic: 'طه',         meaning: 'Ta-Ha',                 revelation_type: 'Meccan',  verses: 135,  starting_page: 627,description: 'Contains the story of Musa (Moses) from his birth to his mission with Pharaoh.', significance: 'Contains the verse: "Every soul tastes death."' },
  ...
  { number: 22,  name: 'Al-Hajj',      name_arabic: 'الحج',       meaning: 'The Pilgrimage',        revelation_type: 'Medinan', verses: 78,   starting_page: 667,description: 'Addresses the pilgrimage to Mecca, the rituals of Hajj and Umrah, and the Prophet\'s Farewell Pilgrimage address.', significance: 'Contains the verse of the Farewell Pilgrimage establishing that the Prophet\'s authority ends with the Quran.' },
  { number: 23,  name: 'Al-Mu\'minun', name_arabic: 'المؤمنون',  meaning: 'The Believers',          revelation_type: 'Meccan',  verses: 118,  starting_page: 687,description: 'Describes the qualities of the true believers, the stages of human creation, and the signs of Allah.', significance: 'The surah opens with the description of the believers that is read in daily Salah.' },
  ...
  { number: 26,  name: 'Ash-Shu\'ara', name_arabic: 'الشعراء',  meaning: 'The Poets',              revelation_type: 'Meccan',  verses: 227,  starting_page: 737,description: 'Contains the stories of Musa, Ibrahim, Nuh, Hud, Salih, Lut, and Shu\'ayb.', significance: 'Contains the verse: "And your Lord is the Most Blessed and Exalted."' },
  ...
  { number: 28,  name: 'Al-Qasas',     name_arabic: 'القصص',    meaning: 'The Stories',            revelation_type: 'Meccan',  verses: 88,   starting_page: 773,description: 'Contains the detailed story of Musa (Moses) from birth to his mission.', significance: 'Contains the verse: "Indeed, he who comes to Allah with a sound heart comes with a good deed."' },
  ...
  { number: 30,  name: 'Ar-Rum',       name_arabic: 'الروم',    meaning: 'The Romans',             revelation_type: 'Meccan',  verses: 60,   starting_page: 811,description: 'Predicted the Roman victory over Persia within 3–9 years — a prophecy fulfilled exactly.', significance: 'Contains the famous verse: "Do they not see how Allah brings the dead to life?"' },
  ...
  { number: 34,  name: 'Saba',         name_arabic: 'سبأ',       meaning: 'Sheba',                  revelation_type: 'Meccan',  verses: 54,   starting_page: 859,description: 'Named after the people of Sheba, recounting the story of Bilqis and Sulayman.', significance: 'Contains the verse: "This is indeed a noble Quran in a preserved Register."' },
  { number: 35,  name: 'Fatir',        name_arabic: 'فاطر',     meaning: 'The Originator',          revelation_type: 'Meccan',  verses: 45,   starting_page: 871,description: 'Emphasizes the signs of Allah in creation, calling humanity to reflect and believe.', significance: 'Contains the verse: "Whoever does righteousness — it is for his soul."' },
  { number: 36,  name: 'Ya-Sin',       name_arabic: 'يس',        meaning: 'Ya-Sin',                 revelation_type: 'Meccan',  verses: 83,   starting_page: 883,description: 'Known as the "heart of the Quran." It addresses resurrection and the proof of the Quran.', significance: 'Reciting Ya-Sin on Friday night is mustahab. It is the Surah of the dead city.' },
  ...
  { number: 38,  name: 'Sad',          name_arabic: 'ص',         meaning: 'Sad',                    revelation_type: 'Meccan',  verses: 88,   starting_page: 909,description: 'Addresses the stories of Dawud and Sulayman, the proofs of prophethood.', significance: 'Contains the story of the hoopoe bird and Sulayman\'s kingdom.' },
  { number: 39,  name: 'Az-Zumar',     name_arabic: 'الزمر',   meaning: 'The Groups',             revelation_type: 'Meccan',  verses: 75,   starting_page: 919,description: 'Addresses resurrection, accountability, and the parable of those who take guardians besides Allah.', significance: 'Contains the verse: "Is not the time come for those who have believed?"' },
  ...
  { number: 41,  name: 'Fussilat',     name_arabic: 'فصلت',     meaning: 'Explained in Detail',    revelation_type: 'Meccan',  verses: 54,   starting_page: 957,description: 'Explains the signs of Allah in creation and the Quran\'s clarity.', significance: 'Contains the verse: "This is a mercy from your Lord."' },
  ...
  { number: 43,  name: 'Az-Zukhruf',   name_arabic: 'الزخرف',  meaning: 'The Gold Adornments',     revelation_type: 'Meccan',  verses: 89,   starting_page: 981,description: 'Warns against the decorative false beliefs of the disbelievers.', significance: 'Contains the verse: "He [Musa] said: Do you see what you call upon besides Allah?"' },
  ...
  { number: 47,  name: 'Muhammad',     name_arabic: 'محمد',     meaning: 'Muhammad',               revelation_type: 'Medinan', verses: 38,   starting_page: 1017,description: 'Addresses the believers about fighting the disbelievers and the consequences of hypocrisy.', significance: 'Contains the verse: "Allah has promised those who believe and do righteous deeds."' },
  { number: 48,  name: 'Al-Fath',      name_arabic: 'الفتح',    meaning: 'The Victory',             revelation_type: 'Medinan', verses: 29,   starting_page: 1025,description: 'Celebrates the Treaty of Hudaybiyyah — a pivotal moment for the Muslim community.', significance: 'Contains the famous verse: "Muhammad is the Messenger of Allah; and those with him are firm."' },
  { number: 49,  name: 'Al-Hujurat',   name_arabic: 'الحجرات', meaning: 'The Rooms',                revelation_type: 'Medinan', verses: 18,   starting_page: 1033,description: 'Addresses the etiquette of the believers — avoiding suspicion, backbiting, and the equality of all humans.', significance: 'Contains the verse: "Indeed, We have created you from male and female and made you peoples and tribes."' },
  ...
  { number: 51,  name: 'Adh-Dhariyat',name_arabic: 'الذاريات', meaning: 'The Scattering Winds',    revelation_type: 'Meccan',  verses: 60,   starting_page: 1043,description: 'Swears by the winds that scatter, clouds that carry rain, and ships that sail.', significance: 'Contains the famous verse: "And upon Allah is the direction of the affair."' },
  ...
  { number: 54,  name: 'Al-Qamar',     name_arabic: 'القمر',    meaning: 'The Moon',                revelation_type: 'Meccan',  verses: 55,   starting_page: 1059,description: 'Addresses the splitting of the moon — a miracle of Prophet Muhammad.', significance: 'Contains the famous verse: "The Hour has come closer, and the moon has been split."' },
  { number: 55,  name: 'Ar-Rahman',    name_arabic: 'الرحمن',   meaning: 'The Most Merciful',       revelation_type: 'Medinan', verses: 78,   starting_page: 1065,description: 'Enumerates the blessings of Allah and repeatedly asks "Which of your Lord\'s blessings would you deny?"', significance: 'The most frequently recited surah in the Muslim world. It is the Surah of Allah\'s mercy.' },
  ...
  { number: 57,  name: 'Al-Hadid',     name_arabic: 'الحديد',   meaning: 'The Iron',                 revelation_type: 'Medinan', verses: 29,   starting_page: 1077,description: 'Describes iron as benefit to humanity and calls believers to struggle in the way of Allah.', significance: 'Contains the verse: "And strive for Allah with the striving due to Him."' },
  ...
  { number: 59,  name: 'Al-Hashr',     name_arabic: 'الحشر',    meaning: 'The Gathering',            revelation_type: 'Medinan', verses: 24,   starting_page: 1093,description: 'Addresses the exile of the Banu Nadir tribe and the attributes of Allah.', significance: 'Contains the verse: "Whatever thing you spend [for charity] — He will replace it."' },
  ...
  { number: 61,  name: 'As-Saff',      name_arabic: 'الصف',    meaning: 'The Ranks',                revelation_type: 'Medinan', verses: 14,   starting_page: 1105,description: 'Calls believers to be like a built structure — firm and united.', significance: 'Contains the verse: "Indeed, Allah has purchased from the believers their lives and their properties."' },
  ...
  { number: 63,  name: 'Al-Munafiqun', name_arabic: 'المنافقون', meaning: 'The Hypocrites',           revelation_type: 'Medinan', verses: 11,   starting_page: 1111,description: 'Exposes the characteristics of hypocrites.', significance: 'Contains the famous hadith qudsi: "When I love My servant, I am his hearing, his sight."' },
  { number: 64,  name: 'At-Taghabun', name_arabic: 'التغابن',   meaning: 'The Mutual Disillusion',   revelation_type: 'Medinan', verses: 18,   starting_page: 1115,description: 'Addresses the Day when all deeds will be exposed.', significance: 'Contains the verse: "He created the heavens and the earth in truth and formed you in the best of forms."' },
  ...
  { number: 68,  name: 'Al-Qalam',     name_arabic: 'القلم',   meaning: 'The Pen',                  revelation_type: 'Meccan',  verses: 52,   starting_page: 1131,description: 'Swears by the pen — the first thing created. Addresses the slandering of the Prophet.', significance: 'Contains the famous verse: "The soul and He who proportioned it — then inspired it with its wickedness and its righteousness."' },
  { number: 69,  name: 'Al-Haqqa',     name_arabic: 'الحاقة',  meaning: 'The Reality',              revelation_type: 'Meccan',  verses: 52,   starting_page: 1135,description: 'Describes the Day of Judgment in vivid detail.', significance: 'Contains the famous verse: "Indeed, this is the truth from your Lord."' },
  ...
  { number: 75,  name: 'Al-Qiyama',   name_arabic: 'القيامة',  meaning: 'The Resurrection',        revelation_type: 'Meccan',  verses: 40,   starting_page: 1157,description: 'Addresses the doubters of the resurrection.', significance: 'Contains the verse: "Does man not remember that We created him before when he was nothing?"' },
  ...
  { number: 77,  name: 'Al-Mursalat', name_arabic: 'المرسلات', meaning: 'The Emissaries',           revelation_type: 'Meccan',  verses: 50,   starting_page: 1163,description: 'Describes the angels sent with divine commands and the Day of Judgment.', significance: 'Contains the famous verse: "By the winds sent forth in gusts."' },
  ...
  { number: 79,  name: 'An-Nazi\'at', name_arabic: 'النازعات', meaning: 'Those Who Drag Forth',     revelation_type: 'Meccan',  verses: 46,   starting_page: 1169,description: 'Describes the angels who drag souls out at death and the Day of Judgment.', significance: 'Contains the verse: "And the mountains are moved and become like tufts of wool."' },
  { number: 80,  name: 'Abasa',        name_arabic: 'عبس',     meaning: 'He Frowned',              revelation_type: 'Meccan',  verses: 42,   starting_page: 1173,description: 'Teaches that the Prophet was sent to give warning, not to force belief, and guidance is from Allah alone.', significance: 'Teaches that one should not look down on others — the blind man was dearer to Allah than the chieftains of Mecca.' },
  ...
  { number: 82,  name: 'Al-Infitar',  name_arabic: 'الانفطار', meaning: 'The Cleaving',              revelation_type: 'Meccan',  verses: 19,   starting_page: 1177,description: 'Describes the Day when the sky is split open and every soul is brought to account.', significance: 'Contains the verse: "When the sun is wrapped up, when the stars darken."' },
  { number: 83,  name: 'Al-Mutaffifin',name_arabic:'المطففين', meaning: 'The Defrauding',            revelation_type: 'Meccan',  verses: 36,   starting_page: 1177,description: 'Warns against those who give short measure in business.', significance: 'Contains the verse: "Woe to those who give short measure."' },
  { number: 84,  name: 'Al-Inshiqaq',  name_arabic: 'الانشقاق', meaning: 'The Sundering',            revelation_type: 'Meccan',  verses: 25,   starting_page: 1181,description: 'Describes the Day when the earth is stretched out and casts out what is within it.', significance: 'Contains the verse: "When the earth is stretched out and casts out what is within it."' },
  ...
  { number: 86,  name: 'At-Tariq',    name_arabic: 'الطارق',   meaning: 'The Morning Star',         revelation_type: 'Meccan',  verses: 17,   starting_page: 1185,description: 'Emphasizes that humans were created from a clinging substance.', significance: 'Contains the verse: "Indeed, We created man from a sperm-drop mixture, to test him."' },
  ...
  { number: 88,  name: 'Al-Ghashiya', name_arabic: 'الغاشية', meaning: 'The Overwhelming',          revelation_type: 'Meccan',  verses: 26,   starting_page: 1187,description: 'Asks "Has there come upon you the description of the overwhelming event?"', significance: 'Contains the parable: "Is one who is obedient to the believers and the harmful as equal?"' },
  { number: 89,  name: 'Al-Fajr',     name_arabic: 'الفجر',    meaning: 'The Dawn',                  revelation_type: 'Meccan',  verses: 30,   starting_page: 1189,description: 'Swears by the dawn and the ten nights — among the most sacred times in Islam.', significance: 'Contains the famous verse: "By the dawn and ten nights."' },
  { number: 90,  name: 'Al-Balad',    name_arabic: 'البلد',     meaning: 'The City',                 revelation_type: 'Meccan',  verses: 20,   starting_page: 1191,description: 'Addresses the difficulty of the path and emphasizes that guiding to the right path is also difficult.', significance: 'Contains the verse: "Indeed, We have shown him the way, whether he be grateful or ungrateful."' },
  { number: 91,  name: 'Ash-Shams',   name_arabic: 'الشمس',    meaning: 'The Sun',                   revelation_type: 'Meccan',  verses: 15,   starting_page: 1193,description: 'Swears by the sun and its radiance and addresses the parable of Thamud and their she-camel.', significance: 'Contains the famous verse: "Blessed is He who, if He willed, could make for you something better."' },
  { number: 92,  name: 'Al-Layl',     name_arabic: 'الليل',     meaning: 'The Night',                revelation_type: 'Meccan',  verses: 21,   starting_page: 1193,description: 'Contrasts the path of the one who gives in charity versus the one who denies and is ungrateful.', significance: 'Contains the verse: "As for him who gives and fears Allah and believes in the best reward."' },
  ...
  { number: 94,  name: 'Ash-Sharh',   name_arabic: 'الشرح',    meaning: 'The Relief',                revelation_type: 'Meccan',  verses: 8,    starting_page: 1195,description: 'Brings comfort and expands the chest of the Prophet, raising his status.', significance: 'Contains the famous verse: "Indeed, with hardship comes ease."' },
  { number: 95,  name: 'At-Tin',      name_arabic: 'التين',     meaning: 'The Fig',                  revelation_type: 'Meccan',  verses: 8,    starting_page: 1197,description: 'States that humans were created in the best of forms.', significance: 'Contains the verse: "Indeed, the most righteous will be in gardens of eternity."' },
  ...
  { number: 98,  name: 'Al-Bayyina',  name_arabic: 'البينة',   meaning: 'The Clear Proof',           revelation_type: 'Medinan', verses: 8,    starting_page: 1199,description: 'Declares that the Quran is the clear proof from Allah sent after previous scriptures.', significance: 'Contains the verse: "Not equal are the companions of the Fire and the companions of Paradise."' },
  ...
  { number: 100, name: 'Al-Adiyat',   name_arabic: 'العاديات', meaning: 'The Chargers',               revelation_type: 'Meccan',  verses: 11,   starting_page: 1203,description: 'Swears by the swift horses that charge into battle.', significance: 'Contains the verse: "Indeed, mankind is ungrateful to his Lord."' },
  ...
  { number: 102, name: 'At-Takathur', name_arabic: 'التكاثر', meaning: 'The Rivalry',                revelation_type: 'Meccan',  verses: 8,    starting_page: 1207,description: 'Warns against competition for worldly wealth that distracts from the remembrance of Allah.', significance: 'Contains the verse: "You will most certainly come to know."' },
  ...
  { number: 104, name: 'Al-Humaza',   name_arabic: 'الهمزة',   meaning: 'The Traducer',               revelation_type: 'Meccan',  verses: 9,    starting_page: 1211,description: 'Warns against those who find fault with others and accumulate wealth greedily.', significance: 'Contains the famous verse: "Woe to every slanderer and backbiter."' },
  ...
  { number: 109, name: 'Al-Kafirun',  name_arabic: 'الكافرون', meaning: 'The Disbelievers',            revelation_type: 'Meccan',  verses: 6,    starting_page: 1221,description: 'Declares the clear separation: "To you your religion, and to me my religion."', significance: 'Recited in the last rakah of Witr prayer.' },
  ...
  { number: 112, name: 'Al-Ikhlas',   name_arabic: 'الإخلاص', meaning: 'The Sincerity',               revelation_type: 'Meccan',  verses: 4,    starting_page: 1227,description: 'Declares the absolute oneness of Allah — the purest form of Tawhid.', significance: 'Reciting Al-Ikhlas in Salah equals reciting one-third of the Quran.' },
  { number: 113, name: 'Al-Falaq',    name_arabic: 'الفلق',    meaning: 'The Daybreak',                revelation_type: 'Meccan',  verses: 5,    starting_page: 1229,description: 'Seeks Allah\'s protection from the evil of what He created, from darkness, and from witchcraft.', significance: 'Recited with Al-Falaq and Al-Ikhlas for seeking protection from evil and envy.' },
...
function generateSurahPage(surah: typeof SURAH_DATA[0]): string {
  const { number, name, name_arabic, meaning, revelation_type, verses, starting_page, description, significance } = surah;
  const surahSlug = slugify(name);

  const tajweedLegend = TAJWEED_RULES.map(r =>
...
export async function generateStaticParams() {
  return [{ number: '${number.toString().padStart(3, '0')}', slug: '${surahSlug}' }];
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <header className="px-4 py-12 text-center">
        ...
        <div className="flex flex-wrap justify-center items-center gap-4 text-sm text-muted">
          <span>${revelation_type === 'Meccan' ? '🏔️' : '🏙️'} ${revelation_type} Revelation</span>
          <span>•</span>
        ...
        <section>
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <dd className="mt-1 text-lg font-semibold text-foreground">${number}</dd>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
...
${tajweedLegend}
        ...
        <section className="grid grid-cols-2 gap-4">
          ${number > 1 ? `<Link href={"/surah/${number - 1}/" + "${slugify(SURAH_DATA[number - 2]?.name ?? '')}"} className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">← Previous</span>
            <p className="mt-1 font-semibold text-foreground">Surah ${SURAH_DATA[number - 2]?.name ?? ''}</p>
          </Link>` : `<div />`}
          ${number < 114 ? `<Link href={"/surah/${number + 1}/" + "${slugify(SURAH_DATA[number]?.name ?? '')}"} className="rounded-lg border border-border bg-surface p-4 text-center hover:border-accent transition-colors">
            <span className="text-xs text-muted">Next →</span>
            <p className="mt-1 font-semibold text-foreground">Surah ${SURAH_DATA[number]?.name ?? ''}</p>
          </Link>` : `<div />`}
        </section>
...
function generateAll(): void {
  ...
  for (const surah of SURAH_DATA) {
    ...
    const slug    = slugify(surah.name);
    const outPath = join(OUT_DIR, numStr, slug, 'page.tsx');
    mkdirSync(join(OUT_DIR, numStr, slug), { recursive: true });
    writeFileSync(outPath, generateSurahPage(surah), 'utf-8');
  }

  // Index page — list of all 114 Surahs
  const indexData = SURAH_DATA.map(s => ({
...
const SURAHS = ${JSON.stringify(indexData, null, 2)};
...
`;
  ...
  writeFileSync(join(OUT_DIR, 'page.tsx'), indexPage, 'utf-8');

  console.log(`\n✅ Surah intro pages generated`);
  console.log(`   Index: src/app/surah/page.tsx`);
  console.log(`   Individual pages: ${SURAH_DATA.length}`);
  console.log(`   Route: /surah/[1-114]/[slug]`);
}
